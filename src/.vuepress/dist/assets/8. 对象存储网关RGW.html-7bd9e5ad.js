...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-5-radosgw服务高可用配置" tabindex="-1"><a class="header-anchor" href="#_8-5-radosgw服务高可用配置" aria-hidden="true">#</a> 8.5 radosgw服务高可用配置</h2><figure><img src="http://cdn1.ryanxin.live/xxlog/1670125550434-c8a038af-8737-4c7b-9458-790da79c1582.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="_8-5-1-radosgw-http高可用" tabindex="-1"><a class="header-anchor" href="#_8-5-1-radosgw-http高可用" aria-hidden="true">#</a> 8.5.1 radosgw http高可用</h3><h4 id="_8-5-1-1-自定义http端口" tabindex="-1"><a class="header-anchor" href="#_8-5-1-1-自定义http端口" aria-hidden="true">#</a> 8.5.1.1 自定义http端口</h4><p>配置文件可以在ceph deploy服务器修改然后统一推送，或者单独修改每个radosgw服务器的配置为统一配置，然后重启RGW服务。</p>`,32),R={href:"https://docs",target:"_blank",rel:"noopener noreferrer"},q={href:"http://ceph.com/en/latest/radosaw/frontends/",target:"_blank",rel:"noopener noreferrer"},G=s("br",null,null,-1),W={href:"https://docs",target:"_blank",rel:"noopener noreferrer"},z={href:"http://ceph.com/en/latest/radosaw/frontends/",target:"_blank",rel:"noopener noreferrer"},T=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-mgr2 ~<span class="token punctuation">]</span><span class="token comment"># vim /etc/ceph/ceph.conf</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,34);function B(I,C){const e=r("ExternalLinkIcon");return c(),l("div",null,[d,s("p",null,[p,n("是对象存储("),u,n(")的一种实现方式，** RADOS"),m,n("AWSS3"),v,n("SwiftAPI**，在ceph0.8版本之后使用"),b,n("("),s("a",h,[n("https://github.com/civetweb/civetweb)"),a(e)]),n(")的web服务器来响应api请求，客户端使用"),g,n("协议通过"),k,n("与"),f,n("通信默认端口7480，而RGW则通过"),w,n("与ceph集群通信，RGW客户端通过s3或者swift api使用RGW用户进行身份验证，然后RGW网关代表用户利用cephx与ceph存储进行身份验证."),_,n("S3由Amazon于2006年推出，全称为Simple Storage Service,S3定义了对象存储，是对象存储事实上的标准，从某种意义上说，S3 就是对象存储，对象存储就是S3,它是对象存储市场的霸主，后续的对象存储都是对S3的模仿。")]),y,s("p",null,[s("a",x,[n("https://docs.amazonaws.cn/AmazonS3/latest/userguide/bucketnamingrules.html"),a(e)])]),S,s("p",null,[s("a",R,[n("https://docs"),a(e)]),n(". "),s("a",q,[n("ceph.com/en/latest/radosaw/frontends/"),a(e)]),G,n("[链接]("),s("a",W,[n("https://docs"),a(e)]),n(". "),s("a",z,[n("ceph.com/en/latest/radosaw/frontends/"),a(e)]),n(")")]),T,s("p",null,[n("先将域名解析至负裁均衡的IP"),E,n("172.31.6.201 "),s("a",P,[n("rgw.magedu.net"),a(e)])]),A])}const L=t(o,[["render",B],["__file","8. 对象存储网关RGW.html.vue"]]);export{L as default};
