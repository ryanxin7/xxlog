import{_ as n,V as a,W as s,X as e}from"./framework-8eb1d601.js";const i={},p=e(`<h2 id="_6-1-rbd架构图" tabindex="-1"><a class="header-anchor" href="#_6-1-rbd架构图" aria-hidden="true">#</a> 6.1 RBD架构图</h2><p>Ceph可以同时提供对象存储<strong>RADOSGW</strong> 、<strong>块存储RBD</strong>、<strong>文件系统存储Ceph FS</strong><br>RBD即<strong>RADOS Block Device</strong>的简称，RIBD 块存储是常用的存储类型之一，RBD块设备类似磁盘可以被挂载，RBD 块设备具有快照、多副本、克隆和一致性等特性，数据以条带化的方式存储在Ceph集群的多个OSD中，<br><strong>条带化技术</strong>就是一种自动的将1/0 的负载均衡到多个物理磁盘上的技术，条带化技术就是将一块连续的数据分成很多小部分并把他们分别存储到不同磁盘上去.这就能使多个进程同时访问数据的多个不同部分而不会造成磁盘冲突，而且在需要对这种数据进行顺序访问的时候可以获得最大程度上的/O并行能力，从而获得非常好的性能。</p><figure><img src="http://cdn1.ryanxin.live/xxlog/1669948660767-92e57330-688f-40eb-b794-bfe6f0629769.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h2 id="_6-2-创建存储池" tabindex="-1"><a class="header-anchor" href="#_6-2-创建存储池" aria-hidden="true">#</a> 6.2 创建存储池</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ ceph osd pool create rbd-data1 <span class="token number">32</span> <span class="token number">32</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-3-创建img镜像" tabindex="-1"><a class="header-anchor" href="#_6-3-创建img镜像" aria-hidden="true">#</a> 6.3 创建img镜像</h2><p>rbd存储池并不能直接用于块设备，而是需要事先在其中按需创建映像(image) ，并把映像文件作为块设备使用。<br>rbd 命令可用于创建、查看及删除块设备相在的映像(image) ，以及克隆映像、创建快照.将映像回滚到快照和查看快照等管理操作。<br>例如，下面的命令能够在指定的RBD即rbd-data1创建一个名为myimg1的映像:</p><h3 id="_6-3-1-创建镜像" tabindex="-1"><a class="header-anchor" href="#_6-3-1-创建镜像" aria-hidden="true">#</a> 6.3.1 创建镜像</h3><p>创建镜像命令格式:<br></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#创建两个镜像:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-2-查看镜像详细信息" tabindex="-1"><a class="header-anchor" href="#_6-3-2-查看镜像详细信息" aria-hidden="true">#</a> 6.3.2 查看镜像详细信息</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ rbd <span class="token parameter variable">--image</span> data-img2 <span class="token parameter variable">--pool</span> rbd-data1 info
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-3-以json格式显示镜像信息" tabindex="-1"><a class="header-anchor" href="#_6-3-3-以json格式显示镜像信息" aria-hidden="true">#</a> 6.3.3 以json格式显示镜像信息:</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ rbd <span class="token function">ls</span> <span class="token parameter variable">--pool</span> rbd-data1 -<span class="token operator">|</span> <span class="token parameter variable">--format</span> json --pretty-format
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-4-镜像的其他特性" tabindex="-1"><a class="header-anchor" href="#_6-3-4-镜像的其他特性" aria-hidden="true">#</a> 6.3.4 镜像的其他特性</h3><p><strong>特性简介</strong><br><strong>layering</strong>:支持镜像分层快照特性，用于快照及写时复制，可以对image创建快照并保护，然后从快照克隆出新的image出来，父子image之间采用COW技术，共享对象数据。<br><strong>striping</strong>:支持条带化v2，类似raid 0 ，只不过在ceph环境中的数据被分散到不同的对象中，可改善顺序读写场景较多情况下的性能。</p><p><strong>exclusive-lock</strong>: 支持独占锁，限制-一个镜像只能被一个客户端 使用.<br><strong>object-map</strong>: 支持对象映射(依赖<strong>exclusive-lock</strong>),加速数据导人导出及已用空间统计等，此特性开启的时候，会记录image所有对象的一个位图，用以标记对象是否真的存在，在一些场景下可以加速io。</p><p><strong>fast-diff</strong>: 快速计算镜像与快照数据差异对比(依赖object-map).<br><strong>deep-flatten</strong>: 支持快照扁平化操作，用于快照管理时解决快照依赖关系等。<br><strong>journaling</strong>: 修改数据是否记录日志，该特性可以通过记录日志并通过日志恢复数据(依赖独占锁)，开启此特性会增加系统磁盘I0使用.</p><p>jewel默认开启的特性包括: <strong>layering/exlcusive lock/object map/fast diff/deep flatten</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ rbd <span class="token builtin class-name">help</span> feature <span class="token builtin class-name">enable</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-6-镜像特性的启用" tabindex="-1"><a class="header-anchor" href="#_6-3-6-镜像特性的启用" aria-hidden="true">#</a> 6.3.6 镜像特性的启用</h3><p>启用指定存储池中的指定镜像的特性:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ rbd feature <span class="token builtin class-name">enable</span> exclusive-lock <span class="token parameter variable">--pool</span> rbd-data1 <span class="token parameter variable">--image</span> data-img1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-7-镜像特性的禁用" tabindex="-1"><a class="header-anchor" href="#_6-3-7-镜像特性的禁用" aria-hidden="true">#</a> 6.3.7 镜像特性的禁用</h3><p>禁用指定存储池中指定镜像的特性</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ rbd feature disable fast-diff <span class="token parameter variable">--pool</span> rbd-data1 <span class="token parameter variable">--image</span> data-img1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-4-配置客户端使用rbd" tabindex="-1"><a class="header-anchor" href="#_6-4-配置客户端使用rbd" aria-hidden="true">#</a> 6.4 配置客户端使用RBD</h2><p>在centos客户端挂载RBD，并分别使用admin及普通用户挂载RBD并验证使用.</p><h3 id="_6-4-1-客户端配置yum源" tabindex="-1"><a class="header-anchor" href="#_6-4-1-客户端配置yum源" aria-hidden="true">#</a> 6.4.1 客户端配置yum源</h3><p>客户端要想挂载使用ceph RBD，需要安装ceph客户端组件<strong>ceph-common</strong>，但是<br>ceph-common不在cenos的yum仓库，因此需要单独配置yum源。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#配置yum源:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-2-客户端安装ceph-common" tabindex="-1"><a class="header-anchor" href="#_6-4-2-客户端安装ceph-common" aria-hidden="true">#</a> 6.4.2 客户端安装ceph-common:</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> ceph-common
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_6-4-3-客户端使用普通用户挂载并使用rbd" tabindex="-1"><a class="header-anchor" href="#_6-4-3-客户端使用普通用户挂载并使用rbd" aria-hidden="true">#</a> 6.4.3 客户端使用普通用户挂载并使用RBD</h3><p>创建普通账户并授权:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#创建普通账户</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>拷贝配置文件与普通账户keyring文件到客户端</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">scp</span> ceph.cpnf ceph.client.shiie.keyring root@172.31.6.201:/etc/ceph
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_6-4-4-在客户端验证权限" tabindex="-1"><a class="header-anchor" href="#_6-4-4-在客户端验证权限" aria-hidden="true">#</a> 6.4.4 在客户端验证权限</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client2 ~<span class="token punctuation">]</span><span class="token comment"># cd /etc/ceph/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-5-映射rbd" tabindex="-1"><a class="header-anchor" href="#_6-4-5-映射rbd" aria-hidden="true">#</a> 6.4.5 映射rbd</h3><p>使用普通用户权限映射rbd</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#映射rbd</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://cdn1.ryanxin.live/xxlog/1669957144116-253e56a8-a026-400c-bc6f-b54aae46f5a7.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="_6-4-6-格式化并使用rbd镜像" tabindex="-1"><a class="header-anchor" href="#_6-4-6-格式化并使用rbd镜像" aria-hidden="true">#</a> 6.4.6 格式化并使用rbd镜像</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client2 ceph<span class="token punctuation">]</span><span class="token comment"># mkfs.ext4 /dev/rbd0</span>
...
data-img2 <span class="token number">5</span> GiB    <span class="token number">2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-7-验证ceph内核模块" tabindex="-1"><a class="header-anchor" href="#_6-4-7-验证ceph内核模块" aria-hidden="true">#</a> 6.4.7 验证ceph内核模块</h3><p>挂载rbd之后系统内核会自动加载 <strong>libceph.ko</strong> 模块</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#centos </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-8-rbd镜像空间拉伸" tabindex="-1"><a class="header-anchor" href="#_6-4-8-rbd镜像空间拉伸" aria-hidden="true">#</a> 6.4.8 rbd镜像空间拉伸</h3><p>可以扩展空间，不建议缩小空间</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#当前rbd镜像空间大小</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-9-开机自动挂载" tabindex="-1"><a class="header-anchor" href="#_6-4-9-开机自动挂载" aria-hidden="true">#</a> 6.4.9 开机自动挂载</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client2 ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/rc.d/rc.local</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-10-卸载rbd镜像" tabindex="-1"><a class="header-anchor" href="#_6-4-10-卸载rbd镜像" aria-hidden="true">#</a> 6.4.10 卸载rbd镜像</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client2 ceph<span class="token punctuation">]</span><span class="token comment"># umount /data</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-11-删除rbd镜像" tabindex="-1"><a class="header-anchor" href="#_6-4-11-删除rbd镜像" aria-hidden="true">#</a> 6.4.11 删除rbd镜像</h3><p>镜像删除后数据也会被删除而且是无法恢复，因此在执行删除操作的时候要慎重。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ rbd <span class="token builtin class-name">help</span> <span class="token function">rm</span>
usage: rbd <span class="token function">rm</span> <span class="token punctuation">[</span>--pool <span class="token operator">&lt;</span>pool<span class="token operator">&gt;</span><span class="token punctuation">]</span> <span class="token punctuation">[</span>--image <span class="token operator">&lt;</span>image<span class="token operator">&gt;</span><span class="token punctuation">]</span> <span class="token punctuation">[</span>--no-progress<span class="token punctuation">]</span>
              <span class="token operator">&lt;</span>image-spec<span class="token operator">&gt;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-12-rbd镜像回收站机制" tabindex="-1"><a class="header-anchor" href="#_6-4-12-rbd镜像回收站机制" aria-hidden="true">#</a> 6.4.12 rbd镜像回收站机制</h3><p>删除的镜像数据无法恢复,但是还有另外一种方法可以先把镜像移动到回收站，后期确认删除的时候再从回收站删除即可。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster$ rbd <span class="token builtin class-name">help</span> trash 
...
NAME SIZE PARENT FMT PROT LOCK
data-img2 <span class="token number">8</span> GiB  <span class="token number">2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-5-镜像快照" tabindex="-1"><a class="header-anchor" href="#_6-5-镜像快照" aria-hidden="true">#</a> 6.5 镜像快照</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ rbd <span class="token builtin class-name">help</span> snap
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-5-1-创建快照" tabindex="-1"><a class="header-anchor" href="#_6-5-1-创建快照" aria-hidden="true">#</a> 6.5.1 创建快照</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">(</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ rbd <span class="token builtin class-name">help</span> snap create
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-5-2-删除数据并还原快照" tabindex="-1"><a class="header-anchor" href="#_6-5-2-删除数据并还原快照" aria-hidden="true">#</a> 6.5.2 删除数据并还原快照</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>关闭服务<span class="token operator">&gt;</span>取消挂载 <span class="token operator">&gt;</span> 取消映射 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-5-3-删除快照" tabindex="-1"><a class="header-anchor" href="#_6-5-3-删除快照" aria-hidden="true">#</a> 6.5.3 删除快照</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#删除指定快照</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-5-4-快照数量限制" tabindex="-1"><a class="header-anchor" href="#_6-5-4-快照数量限制" aria-hidden="true">#</a> 6.5.4 快照数量限制</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#设置与修改快照数量限制</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,72),t=[p];function l(c,o){return a(),s("div",null,t)}const d=n(i,[["render",l],["__file","6. Ceph-RBD使用.html.vue"]]);export{d as default};
