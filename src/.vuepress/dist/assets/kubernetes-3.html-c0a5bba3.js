import{_ as t,V as p,W as c,$ as n,a0 as s,Y as l,Z as a,C as o}from"./framework-91fce522.js";const i={},u=a(`<p><a name="OkmdV"></a></p><h2 id="_1-yaml格式" tabindex="-1"><a class="header-anchor" href="#_1-yaml格式" aria-hidden="true">#</a> 1. yaml格式</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>人员名单:
  张三:
