import{_ as i,V as l,W as p,$ as n,a0 as s,Y as a,Z as o,C as c}from"./framework-91fce522.js";const t={},r=n("br",null,null,-1),d={href:"http://docs.ceph.org.cn/rados/",target:"_blank",rel:"noopener noreferrer"},u=o(`<h2 id="_4-1-通过套接字进行单机管理" tabindex="-1"><a class="header-anchor" href="#_4-1-通过套接字进行单机管理" aria-hidden="true">#</a> 4.1:通过套接字进行单机管理</h2><p>每个node节点上都有不同数量的OSD数量</p><p>启动osd进程会在 /var/run/ceph下生成soke文件</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ls</span> /var/run/ceph
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-1-关闭顺序" tabindex="-1"><a class="header-anchor" href="#_4-2-1-关闭顺序" aria-hidden="true">#</a> 4.2.1 关闭顺序</h3><ol><li>关闭服务前设置noout</li><li>关闭存储客户端停止读写数据</li><li>如果使用RGW，关闭RGW</li><li>关闭cephfs 元数据服务</li><li>关闭ceph OSD</li><li>关闭ceph manager</li><li>关闭 ceph monitor</li></ol><h3 id="_4-2-2-启动顺序" tabindex="-1"><a class="header-anchor" href="#_4-2-2-启动顺序" aria-hidden="true">#</a> 4.2.2 启动顺序</h3><ol><li>启动 ceph monitor</li><li>启动 ceph manager</li><li>启动 ceph OSD</li><li>启动 ceph FS 元数据服务</li><li>启动RGW</li><li>启动存储客户端</li><li>启动服务后取消 noout</li></ol><h3 id="_4-2-3-服务时间偏差" tabindex="-1"><a class="header-anchor" href="#_4-2-3-服务时间偏差" aria-hidden="true">#</a> 4.2.3 服务时间偏差</h3>`,19),m={href:"http://docs.ceph.org.cn/rados/configuration/mon-config-ref/",target:"_blank",rel:"noopener noreferrer"},b=o(`<p>重启发现：</p><blockquote><p>cluster: id:5ac860ab- 9a4e- 4edd- 9da2 e3de293a8d44 health: HEALTH WARN clock skew detected on mon. ceph-mon2, mon. ceph-mon3 noout flag(s) set</p></blockquote><p>通常由于服务器重启后导致时间不太一致，因为服务器有时间同步计划任务同步周期还没到</p><p>可以设置监视器运行的时钟漂移量，默认为0.050秒即50毫秒</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">cat</span> /ceph.conf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,44);function S(x,D){const e=c("ExternalLinkIcon");return l(),p("div",null,[n("p",null,[s("ceph集群配置、部署与运维"),r,n("a",d,[s("http://docs.ceph.org.cn/rados/"),a(e)])]),u,n("p",null,[n("a",m,[s("http://docs.ceph.org.cn/rados/configuration/mon-config-ref/"),a(e)])]),b,n("p",null,[s("一个磁盘可能属于多个PG分别担任不同的角色，"),v,n("a",h,[s("https://docs.ceph.com/en/mimic/rados/configuration/pool-pg-config-ref/"),a(e)])]),g,n("p",null,[s("存储池的管理通常保存创建、列出、重命名和删除等操作，管理工具使用ceph osd pool"),k,s("的子命令及参数，比如create/ls/rename/rm等。"),_,s("ceph官方运维手册"),f,n("a",q,[s("http://docs.ceph.org.cn/rados/"),a(e)])]),y])}const P=i(t,[["render",S],["__file","4.Ceph集群维护.html.vue"]]);export{P as default};
