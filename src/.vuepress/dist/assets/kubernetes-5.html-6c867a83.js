import{_ as t,V as l,W as p,Z as n,a0 as a,Y as e,$ as i,C as c}from"./framework-7e159c24.js";const o={},u=i(`<p><a name="Ti5Lf"></a></p><h2 id="自定义镜像-运行nginx与tomcat实现动静分离" tabindex="-1"><a class="header-anchor" href="#自定义镜像-运行nginx与tomcat实现动静分离" aria-hidden="true">#</a> 自定义镜像-运行nginx与tomcat实现动静分离</h2><figure><img src="https://cdn.nlark.com/yuque/0/2023/png/33538388/1673526070905-fa3a6810-3329-4dbd-9896-e1da10114b61.png#averageHue=%23fdfbfa&amp;clientId=u37cd80e8-479b-4&amp;from=paste&amp;height=263&amp;id=u9336b92c&amp;name=图片.png&amp;originHeight=409&amp;originWidth=1172&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=36727&amp;status=done&amp;style=none&amp;taskId=u643a3c48-fcf6-45e6-ae28-d284e65aac4&amp;title=&amp;width=755" alt="图片.png" tabindex="0" loading="lazy"><figcaption>图片.png</figcaption></figure><p><a name="IRPqD"></a></p><h3 id="_1-系统基础镜像" tabindex="-1"><a class="header-anchor" href="#_1-系统基础镜像" aria-hidden="true">#</a> 1. 系统基础镜像</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>harbor.ceamg.com/baseimages/centos:7.8.2003
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://cdn.nlark.com/yuque/0/2023/png/33538388/1673869796202-9de30c77-d621-466e-ab4c-e8a5060d9ed9.png#averageHue=%23171411&amp;clientId=u910bc575-a904-4&amp;from=paste&amp;height=142&amp;id=u5f1168b1&amp;name=image.png&amp;originHeight=142&amp;originWidth=733&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=12950&amp;status=done&amp;style=none&amp;taskId=u254b7563-9b0d-41cc-be00-444ba36b0da&amp;title=&amp;width=733" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><p>启动nginx pod</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">kind</span><span class="token punctuation">:</span> Deployment
<span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
  <span class="token key atrule">labels</span><span class="token punctuation">:</span>
