import{_ as p,V as l,W as i,Z as n,a0 as s,Y as t,$ as a,C as o}from"./framework-7e159c24.js";const c={},u=a(`<p><strong>Pod状态</strong><br><img src="https://cdn.nlark.com/yuque/0/2023/png/33538388/1674895053415-2477036f-d642-41c9-90c7-942d1a238360.png#averageHue=%23f7f7f7&amp;clientId=uafa4f2ec-2bc7-4&amp;from=paste&amp;height=329&amp;id=u315f4e81&amp;name=image.png&amp;originHeight=329&amp;originWidth=995&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=43391&amp;status=done&amp;style=none&amp;taskId=u79ab7eca-4ef7-4dc1-8160-2142481a5d3&amp;title=&amp;width=995" alt="image.png" loading="lazy"></p><blockquote><p>**第一阶段 **</p><ol><li>**Pending **正在创建Pod但是Pod中的容器还没有全部被创建完成=[处于此状态的Pod应该检查Pod依赖的存储是否有权限挂载、镜像是否可以下载、调度是否正常等。</li><li>**Failed **Pod中有容器启动失败而导致pod工作异常。</li><li>**Unknown **由于某种原因无法获得pod的当前状态，通常是由于与pod所在的node节点通信错误。</li><li><strong>Succeeded</strong> Pod中的所有容器都被成功终止即pod里所有的containers均已terminated.</li></ol></blockquote><blockquote><p><strong>第二阶段</strong></p><ol><li>**Unschedulable **Pod不能被调度，kube-scheduler没有匹配到合适的node节点。</li><li><strong>Podscheduled</strong> pod正处于调度中，在kube-scheduler刚开始调度的时候，还没有将pod分配到指定的node，在筛选出合适的节点后就会更新etcd数据，将pod分配到指定的node。</li><li><strong>Initialized <strong>所有pod中的初始化容器已经完成了</strong>。</strong></li><li>**ImagePullBackoff **Pod所在的node节点下载镜像失败</li><li>**Running **Pod内部的容器已经被创建并且启动。</li><li>**Ready **表示pod中的容器已经可以提供访问服务</li></ol></blockquote><figure><img src="https://cdn.nlark.com/yuque/0/2023/png/33538388/1674895376985-f56a789b-45f8-418b-836c-22314b8775f4.png#averageHue=%23e8902d&amp;clientId=uafa4f2ec-2bc7-4&amp;from=paste&amp;height=521&amp;id=u80aebc58&amp;name=image.png&amp;originHeight=521&amp;originWidth=1063&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=104601&amp;status=done&amp;style=none&amp;taskId=ufdad4585-bf84-4d20-a810-7d8bea6d2ac&amp;title=&amp;width=1063" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Error: <span class="token comment">#pod 启动过程中发生错误</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="G2mEC"></a></p><h2 id="pod-探针" tabindex="-1"><a class="header-anchor" href="#pod-探针" aria-hidden="true">#</a> Pod 探针</h2>`,7),r={href:"https://kubernetes.io/zh-cn/docs/concepts/workloads/pods/pod-lifecycle/",target:"_blank",rel:"noopener noreferrer"},d=a(`<p><a name="BKb32"></a></p><h3 id="探针简介" tabindex="-1"><a class="header-anchor" href="#探针简介" aria-hidden="true">#</a> 探针简介</h3><p>探针 是由 kubelet 对容器执行的定期诊断，以保证Pod的状态始终处于运行状态，要执行诊断，kubelet 调用由容器实现的Handler(处理程序)，有三种类型的处理程序:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>ExecAction
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>每次探测都将获得以下三种结果之一：</strong></p><ul><li>成功: 容器通过了诊断</li><li>失败: 容器未通过诊断</li><li>未知: 诊断失败，因此不会采取任何行动</li></ul><p><a name="chN72"></a></p><h2 id="配置探针" tabindex="-1"><a class="header-anchor" href="#配置探针" aria-hidden="true">#</a> 配置探针</h2><p>实现对Pod的状态检测</p><p><a name="QYrCG"></a></p><h3 id="探针类型" tabindex="-1"><a class="header-anchor" href="#探针类型" aria-hidden="true">#</a> 探针类型</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>livenessProbe
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="yfbZa"></a></p><h3 id="探针配置" tabindex="-1"><a class="header-anchor" href="#探针配置" aria-hidden="true">#</a> 探针配置</h3>`,14),k={href:"https://kubernetes.io/zh-cn/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/",target:"_blank",rel:"noopener noreferrer"},m=n("br",null,null,-1),v=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>initialDelaySeconds: <span class="token number">120</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="OZqi3"></a></p><h3 id="http-探测器可以在-httpget-上配置额外的字段" tabindex="-1"><a class="header-anchor" href="#http-探测器可以在-httpget-上配置额外的字段" aria-hidden="true">#</a> HTTP 探测器可以在 httpGet 上配置额外的字段</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
host:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="YXQF3"></a></p><h3 id="http探针示例" tabindex="-1"><a class="header-anchor" href="#http探针示例" aria-hidden="true">#</a> HTTP探针示例</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment">#apiVersion: extensions/v1beta1</span>
...
<span class="token key atrule">spec</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">selector</span><span class="token punctuation">:</span>
    <span class="token key atrule">app</span><span class="token punctuation">:</span> ng<span class="token punctuation">-</span>deploy<span class="token punctuation">-</span><span class="token number">80</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="ByqZI"></a></p><h3 id="execaction探针" tabindex="-1"><a class="header-anchor" href="#execaction探针" aria-hidden="true">#</a> ExecAction探针 <br></h3><p>可以基于指定的命令对Pod进⾏特定的状态检查。</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
<span class="token key atrule">kind</span><span class="token punctuation">:</span> Deployment
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
...
<span class="token key atrule">spec</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">selector</span><span class="token punctuation">:</span>
    <span class="token key atrule">app</span><span class="token punctuation">:</span> redis<span class="token punctuation">-</span>deploy<span class="token punctuation">-</span><span class="token number">6379</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果端⼝检测连续超过指定的三次都没有通过，则Pod状态如下： <br> <img src="https://cdn.nlark.com/yuque/0/2023/png/33538388/1674961899934-85e91869-b0af-44bb-ad5b-21f9466b891b.png#averageHue=%230f0c0a&amp;clientId=uafa4f2ec-2bc7-4&amp;from=paste&amp;height=232&amp;id=uad12b2d9&amp;name=image.png&amp;originHeight=232&amp;originWidth=682&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=106673&amp;status=done&amp;style=none&amp;taskId=ub7ce59ef-ae7d-4f0e-9a2e-8572d9bd420&amp;title=&amp;width=682" alt="image.png" loading="lazy"></p><p><a name="iTPbt"></a></p><h3 id="livenessprobe和readinessprobe的对比" tabindex="-1"><a class="header-anchor" href="#livenessprobe和readinessprobe的对比" aria-hidden="true">#</a> livenessProbe和readinessProbe的对⽐ <br><br></h3><blockquote><ol><li><strong>配置参数⼀样</strong></li><li>livenessProbe <strong>连续探测失败会重启、重建pod， readinessProbe不会执⾏重启或者重建Pod操作</strong><br>livenessProbe <strong>连续检测指定次数失败后会将容器置于(Crash Loop BackOff)且不可⽤，readinessProbe不会</strong></li><li>readinessProbe <strong>连续探测失败会从service的endpointd中删除该Pod， livenessProbe不具备此功能，但是会将容器挂起livenessProbe</strong></li></ol></blockquote><blockquote><ol start="4"><li><strong>livenessProbe⽤户控制是否重启pod， readinessProbe⽤于控制pod是否添加⾄service</strong></li></ol></blockquote><blockquote></blockquote><p>**建议：<br>两个探针都配置 **</p><p><a name="HKHSU"></a></p><h2 id="pod重启策略" tabindex="-1"><a class="header-anchor" href="#pod重启策略" aria-hidden="true">#</a> Pod重启策略</h2><p>k8s在Pod出现异常的时候会⾃动将Pod重启以恢复Pod中的服务。 <br> :::success <strong>restartPolicy</strong><br><strong>Always</strong>：<strong>当容器异常时， k8s⾃动重启该容器， ReplicationController/Replicaset/Deployment。</strong><br><strong>OnFailure</strong>：<strong>当容器失败时(容器停⽌运⾏且退出码不为0)， k8s⾃动重启该容器。</strong><br><strong>Never</strong>：<strong>不论容器运⾏状态如何都不会重启该容器,Job或CronJob。</strong> ::: <a name="fEK6r"></a></p><h2 id="镜像拉取策略" tabindex="-1"><a class="header-anchor" href="#镜像拉取策略" aria-hidden="true">#</a> 镜像拉取策略</h2><blockquote><p><strong>IfNotPresent</strong> <strong>node节点没有此镜像就去指定的镜像仓库拉取， node有就使⽤node本地镜像。</strong><br><strong>Always</strong> <strong>每次重建pod都会重新拉取镜像</strong><br><strong>Never</strong> **从不到镜像中⼼拉取镜像，只使⽤本地镜像 **</p></blockquote>`,27);function b(y,h){const e=o("ExternalLinkIcon");return l(),i("div",null,[u,n("p",null,[n("a",r,[s("https://kubernetes.io/zh-cn/docs/concepts/workloads/pods/pod-lifecycle/"),t(e)])]),d,n("p",null,[n("a",k,[s("https://kubernetes.io/zh-cn/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/"),t(e)]),m,s("探针有很多配置字段，可以使用这些字段精确的控制存活和就绪检测的行为")]),v])}const P=p(c,[["render",b],["__file","kubernetes-7.html.vue"]]);export{P as default};
