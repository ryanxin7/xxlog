import{_ as n,V as s,W as a,Z as e}from"./framework-91fce522.js";const i={},t=e(`<h1 id="_1-nginx-访问限制" tabindex="-1"><a class="header-anchor" href="#_1-nginx-访问限制" aria-hidden="true">#</a> 1. Nginx 访问限制</h1><p><code>ngx_http_access_module</code>模块允许限制对某些客户端地址的访问。</p><p>这里所说的访问限制主要就是限制来源的客户端 IP 地址，可以设置类似 IP 黑白名单一样的东西，比如某些内部的服务，我们只希望在我们办公室的 IP 能够访问，也比如有个不法分子的 IP 一直在疯狂的请求我们网站，需要把它封了，这些都需要用到该功能。</p><p>Nginx 的 <code>ngx_http_access_module</code> 模块提供了这样的功能，默认编译。主要两个参数：</p><table><thead><tr><th style="text-align:center;">参数</th><th>说明</th></tr></thead><tbody><tr><td style="text-align:center;">allow 允许某个 ip 或者一个 ip 段访问，如果指定 unix: ，那将允许 socket 的访问。语法：allow address</td><td>CIDR</td></tr><tr><td style="text-align:center;">deny 和 allow 相反。语法：deny address</td><td>CIDR</td></tr></tbody></table><h2 id="_1-1-模块指令" tabindex="-1"><a class="header-anchor" href="#_1-1-模块指令" aria-hidden="true">#</a> 1.1 模块指令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
...
Context:http,server,location,limit_except
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h2 id="_1-3-场景示例-拒绝指定的ip访问该网站的-其他ip全部允许访问。" tabindex="-1"><a class="header-anchor" href="#_1-3-场景示例-拒绝指定的ip访问该网站的-其他ip全部允许访问。" aria-hidden="true">#</a> 1.3 场景示例，拒绝指定的IP访问该网站的,其他IP全部允许访问。</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
    server_ name mirror.jx.com<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><p><code>注意</code>:deny和allow的顺序是有影响的<br></p><p>默认情况下，从第一条规则进行匹配,如果匹配成功，则不继续匹配下面的内容。如果匹配不成功，则继续往下寻找能匹配成功的内容。</p><br><br><h1 id="_2-身份验证" tabindex="-1"><a class="header-anchor" href="#_2-身份验证" aria-hidden="true">#</a> 2.身份验证</h1><p><code>ngx_http__auth_basic_module</code> 模块允许使用HTTP基本身份验证，验证用户名和密码来限制对资源的访问.</p><h2 id="_2-1-指令" tabindex="-1"><a class="header-anchor" href="#_2-1-指令" aria-hidden="true">#</a> 2.1 指令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#使用HTTP基本身份验证协议启用用户名和密码验证。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h2 id="_2-2-场景示例-基于用户名和密码认证实践" tabindex="-1"><a class="header-anchor" href="#_2-2-场景示例-基于用户名和密码认证实践" aria-hidden="true">#</a> 2.2 场景示例，基于用户名和密码认证实践</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
...
server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>    
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><br><h2 id="_3-2-场景实践-限制下载速度。" tabindex="-1"><a class="header-anchor" href="#_3-2-场景实践-限制下载速度。" aria-hidden="true">#</a> 3.2 场景实践-限制下载速度。</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
listen <span class="token number">80</span><span class="token punctuation">;</span>
    server_name mirror.jx.com<span class="token punctuation">;</span>
    root /code<span class="token punctuation">;</span>
    charset utf8<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><br><h1 id="_4-nginx-请求限制" tabindex="-1"><a class="header-anchor" href="#_4-nginx-请求限制" aria-hidden="true">#</a> 4. Nginx 请求限制</h1><p>连接限制主要用于处理用户的连接，只算是一方面的限制，而且有时候这样一刀切不是很友好，比如限制了总共允许多少个连接，如果别人属于攻击该网站，一下子建立一万个线程发起连接，可能你连接池两下就撑爆了，真正的用户进步不进来，此时就需要这样一个限制，限制来自同一个客户端的请求我们每秒只给它处理多少个请求，想要请求更多，那就等着，这样连接池不会被占满，别人也能正常使用。</p><h2 id="_4-1-请求频率限速实现的原理" tabindex="-1"><a class="header-anchor" href="#_4-1-请求频率限速实现的原理" aria-hidden="true">#</a> 4.1 请求频率限速实现的原理?</h2><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx频率限速原理.jpg" alt="nginx频率限速原理" tabindex="0" loading="lazy"><figcaption>nginx频率限速原理</figcaption></figure><br><p>如图：水(请求)从上方倒入水桶，从水桶下方流出(被处理) ;<br> 如果说水(请求) 流入的过快，水桶流出(被处理)的过慢，来不及流出的水存在水桶中(缓存)，然后以固定速率流出，水桶满后则水溢出(丢弃)<br><br></p><p><strong>简单来说就是</strong>:当处理速度,达不到请求的速度，则会将请求放置缓存， 然后持续处理。当缓存空间被沾满，如果还有大量的请求，则会被丢弃。<br></p><br><br><p><strong>Nginx</strong> 的 <code>http_limit_req_module</code> 模块就可以实现该需求，并且默认编译。 <br></p><table><thead><tr><th style="text-align:center;">参数</th><th>说明</th></tr></thead><tbody><tr><td style="text-align:center;">limit_req_zone</td><td>设置一块共享内存用来保存键值的状态参数。只能 http 段，语法：<code>limit_req_zone $variable zone=name:size rate=rate</code>;</td></tr><tr><td style="text-align:center;">limit_req_log_level</td><td>设置日志级别。语法：\`limit_req_log_level (info) (notice) (warn) (error);</td></tr><tr><td style="text-align:center;">limit_req_status</td><td>设置拒绝请求的响应状态码，默认 503。语法：<code>limit_req_status code</code>;</td></tr><tr><td style="text-align:center;">limit_req</td><td>设置对应的共享内存限制域和允许被处理的最大请求数阈值。语法：<code>limit_req zone=name [burst=number] [nodelay]</code>;</td></tr></tbody></table><br><p><strong>参数说明</strong>：</p><ul><li><code>limit_req_zone</code>：和之前的 <code>limit_conn_zone</code> 类似，只是多了个 rate 配置，用法也类似。</li><li><code>rate</code>：必须是整数，如 1r/s，如果是2秒处理1个只能换成 30r/m 这样来实现整数。</li><li><code>burst</code>：超出后允许的排队个数。</li><li><code>nodelay</code>：排队也能直接执行，但是再超出则马上返回 503。</li></ul><br><h2 id="_4-2-场景实践-限制单位时间内所产生的http请求数。" tabindex="-1"><a class="header-anchor" href="#_4-2-场景实践-限制单位时间内所产生的http请求数。" aria-hidden="true">#</a> 4.2 场景实践-限制单位时间内所产生的Http请求数。</h2><ol><li>模块指令：</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Syntax: limit_req_zone key <span class="token assign-left variable">zone</span><span class="token operator">=</span>name:size <span class="token assign-left variable">rate</span><span class="token operator">=</span>rate<span class="token punctuation">;</span> 
Default: -
Context: http
...
server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><br>`,79),l=[t];function c(o,d){return s(),a("div",null,l)}const p=n(i,[["render",c],["__file","nginx-limit.html.vue"]]);export{p as default};
