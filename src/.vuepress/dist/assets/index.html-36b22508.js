...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,82);function p(h,g){const s=v("font");return l(),d("div",null,[m,t(" more "),b,e("p",null,[n("在这个流程图中涉及到两种场景："),r(s,{color:"red"},{default:c(()=>[n("实时分析与离线分析")]),_:1}),n("，如果需要使用市面 上的开源解决方案来实现的话，有两套方案比较有优势：")]),o])}const q=a(u,[["render",p],["__file","index.html.vue"]]);export{q as default};
