import{_ as t,V as p,W as l,$ as n,a0 as s,Y as c,Z as a,C as i}from"./framework-91fce522.js";const o={},u=a(`<p><a name="nlbOU"></a></p><h2 id="rbd结合k8s提供存储卷及动态存储卷使用案例" tabindex="-1"><a class="header-anchor" href="#rbd结合k8s提供存储卷及动态存储卷使用案例" aria-hidden="true">#</a> rbd结合k8s提供存储卷及动态存储卷使用案例</h2><blockquote><p><strong>目的：</strong> 让k8s 中的 pod 可以访问 ceph中rbd 提供的镜像作为存储设备。</p></blockquote><p>需要在 ceph 创建rbd并且让 k8s node 节点能够通过 ceph 的认证k8s在使用 ceph 作为动态存储卷的时候，需要 **kube-controller-manager **组件能够访问ceph，因此需要在包括k8s master及 node节点在内的每一个node 同步认证文件。</p><p><a name="eTh1Y"></a></p><h2 id="_1-创建初始化rbd" tabindex="-1"><a class="header-anchor" href="#_1-创建初始化rbd" aria-hidden="true">#</a> 1.创建初始化RBD</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#创建新的rbd</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://cdn1.ryanxin.live/1674889936820-b1e98d87-5f4b-4363-870d-770e69014658.png" alt="验证挂载" tabindex="0" loading="lazy"><figcaption>验证挂载</figcaption></figure><p><a name="M2LZb"></a></p><h2 id="通过secret-挂载rbd" tabindex="-1"><a class="header-anchor" href="#通过secret-挂载rbd" aria-hidden="true">#</a> 通过secret 挂载rbd</h2><p>将key定义为secret ，然后在挂载至pod，每个k8s node 就不用保存keyring文件了。</p><p><a name="W3DTh"></a></p><h3 id="创建secret" tabindex="-1"><a class="header-anchor" href="#创建secret" aria-hidden="true">#</a> 创建secret</h3><p>首先创建secret ，secret中主要就是包含ceph中被授权用户的keyring文件中的key,需要将key内容通过 base64编码后即可创建secret。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#将 key 进行编码</span>
        ...
        <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> rbd<span class="token punctuation">-</span>data1
          <span class="token key atrule">rbd</span><span class="token punctuation">:</span>
            ...
            <span class="token key atrule">secretRef</span><span class="token punctuation">:</span>
              <span class="token key atrule">name</span><span class="token punctuation">:</span> ceph<span class="token punctuation">-</span>secret<span class="token punctuation">-</span>xinceph<span class="token punctuation">-</span>zcc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>查看pod挂载情况<br><img src="https://cdn.nlark.com/yuque/0/2023/png/33538388/1674891101243-0f2488ce-778a-4dda-87b4-90b3c1b1cf9a.png#averageHue=%23171618&amp;clientId=ufb5cd280-a723-4&amp;from=paste&amp;height=390&amp;id=u8bae82ea&amp;name=image.png&amp;originHeight=390&amp;originWidth=1239&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=351754&amp;status=done&amp;style=none&amp;taskId=uc4c9485d-da5a-4879-961e-5ec6b0f6ae9&amp;title=&amp;width=1239" alt="查看pod挂载情况" loading="lazy"></p><p><a name="ZFqiV"></a></p><h2 id="ceph-持久化存储" tabindex="-1"><a class="header-anchor" href="#ceph-持久化存储" aria-hidden="true">#</a> ceph 持久化存储</h2><p><strong>admin secret</strong> 用于k8s master 节点 连接到ceph 自动创建pv ，并关联pvc提供给pod 使用。<br>uer secret 用于pod挂载。</p><figure><img src="http://cdn1.ryanxin.live/1674891447209-73e1dade-be4a-4a07-bbfe-f4c1ecb67858.png" alt="后端存储流程图" tabindex="0" loading="lazy"><figcaption>后端存储流程图</figcaption></figure><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
<span class="token key atrule">kind</span><span class="token punctuation">:</span> Secret
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
        <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> xinceph<span class="token punctuation">-</span>staticdata<span class="token punctuation">-</span>cephfs
          <span class="token key atrule">cephfs</span><span class="token punctuation">:</span>
            ...
            <span class="token key atrule">secretRef</span><span class="token punctuation">:</span>
              <span class="token key atrule">name</span><span class="token punctuation">:</span> ceph<span class="token punctuation">-</span>secret<span class="token punctuation">-</span>admin
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function v(m,b){const e=i("ExternalLinkIcon");return p(),l("div",null,[u,n("p",null,[s("步骤如下："),r,n("a",d,[s("https://www.yuque.com/ryanxx/ga3673/bz0645hbae3emovp"),c(e)])]),k])}const y=t(o,[["render",v],["__file","kubernetes-6.html.vue"]]);export{y as default};
