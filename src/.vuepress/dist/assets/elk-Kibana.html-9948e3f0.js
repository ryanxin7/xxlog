import{_ as i,V as l,W as t,X as c,$ as n,a0 as a,Y as r,Z as s,C as d}from"./framework-91fce522.js";const o={},p=n("p",null,[n("strong",null,"一张图片胜过千万行日志"),a("，Kibana 让您能够自由地选择如何呈现自己的数据。Kibana 是一个免费且开放的用户界面，能够让您对 Elasticsearch 数据进行可视化，并让您在 Elastic Stack 中进行导航。您可以进行各种操作，从跟踪查询负载，到理解请求如何流经您的整个应用，都能轻松完成。")],-1),u=s(`<h2 id="基础知识" tabindex="-1"><a class="header-anchor" href="#基础知识" aria-hidden="true">#</a> 基础知识</h2><h3 id="功能简介" tabindex="-1"><a class="header-anchor" href="#功能简介" aria-hidden="true">#</a> 功能简介</h3><p>Kibana 是一个开源的分析和可视化平台，设计用于和Elasticsearch一起工作。Kibana来搜索，查看，并和存储在Elasticsearch索引中的数据进行交互。可以轻松地执行高级数据分析，并且以各种图标、表格和地图的形式可视化数据。Kibana使得理解大量数据变得很容易。它简单的、基于浏览器的界面使你能够快速创建和共享动态仪表板，实时显示Elasticsearch查询的变化。</p><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/kabina.jpg" alt="kabina" tabindex="0" loading="lazy"><figcaption>kabina</figcaption></figure><br><p><strong>运行环境</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>安装java8环境
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><p><strong>软件包安装</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://artifacts.elastic.co/downloads/kibana/kibana-7.14.0-amd64.deb
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><p><strong>配置查看</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># dpkg -L kibana</span>
/.
/etc
/etc/default
/etc/default/kibana
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><br><h3 id="简单实践" tabindex="-1"><a class="header-anchor" href="#简单实践" aria-hidden="true">#</a> 简单实践</h3><p>命令格式</p><div class="language-basic line-numbers-mode" data-ext="basic"><pre class="language-basic"><code>修改配置文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>`,28),b=n("strong",null,"浏览器查看效果",-1),v={href:"http://192.168.10.108:5601",target:"_blank",rel:"noopener noreferrer"},m=s('<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/ka.jpg" alt="ka" tabindex="0" loading="lazy"><figcaption>ka</figcaption></figure><p>kibana默认帮我们提供了非常多的示例数据</p><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/ka1.jpg" alt="ka1" tabindex="0" loading="lazy"><figcaption>ka1</figcaption></figure><hr><p><strong>小结：</strong></p><ul><li><p>定位 数据的可视化平台</p></li><li><p>部署 安装软件 配置文件 启动查看效果</p></li><li><p>注意： 默认的地图虽然支持中文，但是国家地图有问题，</p></li><li><p>核心点： 1 数据采集 2 数据可视化</p></li></ul>',6);function k(g,h){const e=d("ExternalLinkIcon");return l(),t("div",null,[p,c(" more "),u,n("p",null,[b,a(),n("a",v,[a("http://192.168.10.108:5601"),r(e)])]),m])}const x=i(o,[["render",k],["__file","elk-Kibana.html.vue"]]);export{x as default};
