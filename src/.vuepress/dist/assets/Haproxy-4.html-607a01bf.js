import{_ as n,V as s,W as a,X as e}from"./framework-8eb1d601.js";const t={},i=e(`<p><a name="PyKn5"></a></p><h2 id="六、haproxy-https实现" tabindex="-1"><a class="header-anchor" href="#六、haproxy-https实现" aria-hidden="true">#</a> 六、HAProxy https实现</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#配置HAProxy支持https协议，支持ssl会话；</span>
