import{_ as o,V as l,W as p,Y as n,Z as s,a0 as e,X as t,C as i}from"./framework-8eb1d601.js";const c={},r={href:"https://www.yuque.com/attachments/yuque/0/2023/pdf/33538388/1672721011349-4455b094-61ee-4956-a375-07ad6fc387a1.pdf",target:"_blank",rel:"noopener noreferrer"},u=t(`<p><a name="lXlPc"></a></p><h2 id="_1-基础环境配置" tabindex="-1"><a class="header-anchor" href="#_1-基础环境配置" aria-hidden="true">#</a> 1.基础环境配置</h2><p><a name="jRBYX"></a></p><h3 id="_1-1-时间同步" tabindex="-1"><a class="header-anchor" href="#_1-1-时间同步" aria-hidden="true">#</a> 1.1 时间同步</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ln</span> <span class="token parameter variable">-sf</span> /usr/share/zoneinfo/Asia/Shanghai /etc/localtime
