...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17),I={href:"https://kubernetes.io/zh-cn/docs/concepts/storage/persistent-volumes/#access-modes",target:"_blank",rel:"noopener noreferrer"},q=t(`<p><strong>官⽅提供的基于各后端存储创建的PV⽀持的访问模式</strong></p><figure><img src="http://cdn1.ryanxin.live/1673421868807-b85faeed-f417-408f-8c0b-92bb351f28e4.png" alt="⽀持的访问模式" tabindex="0" loading="lazy"><figcaption>⽀持的访问模式</figcaption></figure><p><a name="hymYN"></a></p><h5 id="回收机制-persistentvolumereclaimpolicy" tabindex="-1"><a class="header-anchor" href="#回收机制-persistentvolumereclaimpolicy" aria-hidden="true">#</a> 回收机制 persistentVolumeReclaimPolicy</h5><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>persistentVolumeReclaimPolicy <span class="token comment">#删除机制即删除存储卷卷时候，已经创建好的存储卷由以下删除操作：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),F={href:"https://kubernetes.io/zh-cn/docs/concepts/storage/persistent-volumes/#reclaim-policy",target:"_blank",rel:"noopener noreferrer"},G=n("a",{name:"n5UOP"},null,-1),W=t(`<h5 id="卷模式" tabindex="-1"><a class="header-anchor" href="#卷模式" aria-hidden="true">#</a> 卷模式</h5><p>针对 PV 持久卷，Kubernetes 支持两种卷模式（volumeModes）：Filesystem（文件系统） 和 Block（块）。 volumeMode 是一个可选的 API 参数。 如果该参数被省略，默认的卷模式是 Filesystem。<br>volumeMode 属性设置为 Filesystem 的卷会被 Pod <strong>挂载（Mount）</strong> 到某个目录。 如果卷的存储来自某块设备而该设备目前为空，Kuberneretes 会在第一次挂载卷之前在设备上创建文件系统。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>volumeMode <span class="token comment">#卷类型</span>
kubectl explain PersistentVolume.spec.volumeMode
定义存储卷使⽤的⽂件系统是块设备还是⽂件系统，默认为⽂件系统
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),j={href:"https://kubernetes.io/zh-cn/docs/concepts/storage/persistent-volumes/#volume-mode",target:"_blank",rel:"noopener noreferrer"},K=t(`<p><a name="TOaVN"></a></p><h5 id="-1" tabindex="-1"><a class="header-anchor" href="#-1" aria-hidden="true">#</a></h5><p><img src="http://cdn1.ryanxin.live/1673421245380-7d31902c-15fe-438e-bbb0-903154cceac9.png" alt="" loading="lazy"><a name="IRoju"></a></p><h4 id="persistentvolumeclaim-参数" tabindex="-1"><a class="header-anchor" href="#persistentvolumeclaim-参数" aria-hidden="true">#</a> PersistentVolumeClaim 参数</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#kubectl explain PersistentVolumeClaim</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="y3crT"></a></p><h4 id="pv及pvc实战案例之zookeeper集群" tabindex="-1"><a class="header-anchor" href="#pv及pvc实战案例之zookeeper集群" aria-hidden="true">#</a> PV及PVC实战案例之zookeeper集群</h4><p>基于PV和PVC作为后端存储，实现zookeeper集群</p><p><a name="yoVLV"></a></p><h5 id="_1-下载jdk-镜像" tabindex="-1"><a class="header-anchor" href="#_1-下载jdk-镜像" aria-hidden="true">#</a> 1.下载JDK 镜像<br><br></h5>`,10),L={href:"https://www.oracle.com/java/technologies/javase/javase8u211-later-archive-downloads.html#license-lightbox",target:"_blank",rel:"noopener noreferrer"},Y=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull elevy/slim_java:8
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="IPZyn"></a></p><h5 id="_2-构建zookeeper-镜像" tabindex="-1"><a class="header-anchor" href="#_2-构建zookeeper-镜像" aria-hidden="true">#</a> 2.构建zookeeper 镜像</h5><figure><img src="http://cdn1.ryanxin.live/1673486581523-20c135bc-2fde-45aa-bc2b-c3fb840e5e15.png" alt="zookeeper镜像" tabindex="0" loading="lazy"><figcaption>zookeeper镜像</figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">chmod</span> a+x *.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://cdn1.ryanxin.live/1673500958747-eff6d385-4fe1-40ed-b37f-7cf55130f909.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://cdn1.ryanxin.live/1673501722922-ecbd4d14-94cb-4e72-a577-8cdb28e7450e.png" alt="zookeeper测试" tabindex="0" loading="lazy"><figcaption>zookeeper测试</figcaption></figure>`,44);function X($,U){const a=o("ExternalLinkIcon");return l(),i("div",null,[r,n("p",null,[u,s("：副本控制器（selector = !=）"),d,n("a",k,[s("https://kubernetes.io/zh-cn/docs/concepts/workloads/controllers/replicationcontroller/"),e(a)]),v,s("• "),n("a",m,[s("https://kubernetes.io/zh/docs/concepts/overview/working-with-objects/labels/"),e(a)])]),n("p",null,[b,s("：副本控制集，和副本控制器的区别是：对选择器的支持（selector 还支持in notin）"),h,s("• "),n("a",y,[s("https://kubernetes.io/zh/docs/concepts/workloads/controllers/replicaset/"),e(a)])]),n("p",null,[g,s("：比rs更高一级的控制器，除了有rs的功能之外，还有很多高级功能,，比如说最重要的：滚动升级、回滚等"),f,s("• "),n("a",z,[s("https://kubernetes.io/zh/docs/concepts/workloads/controllers/deployment/"),e(a)])]),x,n("p",null,[s(":::tips "),n("a",P,[s("创建 Deployment 以将 ReplicaSet 上线"),e(a)]),s("。ReplicaSet 在后台创建 Pod。 检查 ReplicaSet 的上线状态，查看其是否成功。")]),n("ol",null,[n("li",null,[n("p",null,[s("通过更新 Deployment 的 PodTemplateSpec，"),n("a",_,[s("声明 Pod 的新状态"),e(a)]),s(" 。 新的 ReplicaSet 会被创建，Deployment 以受控速率将 Pod 从旧 ReplicaSet 迁移到新 ReplicaSet。 每个新的 ReplicaSet 都会更新 Deployment 的修订版本。")])]),n("li",null,[n("p",null,[s("如果 Deployment 的当前状态不稳定，"),n("a",V,[s("回滚到较早的 Deployment 版本"),e(a)]),s("。 每次回滚都会更新 Deployment 的修订版本。")])]),n("li",null,[n("p",null,[n("a",C,[s("扩大 Deployment 规模以承担更多负载"),e(a)]),s("。")])]),n("li",null,[n("p",null,[n("a",S,[s("暂停 Deployment 的上线"),e(a)]),s(" 以应用对 PodTemplateSpec 所作的多项修改， 然后恢复其执行以启动新的上线版本。")])]),n("li",null,[n("p",null,[n("a",R,[s("使用 Deployment 状态"),e(a)]),s("来判定上线过程是否出现停滞。")])]),n("li",null,[n("p",null,[n("a",O,[s("清理较旧的不再需要的 ReplicaSet"),e(a)]),s(" 。 :::")])])]),M,n("p",null,[n("a",N,[s("https://kubernetes.io/zh-cn/docs/concepts/storage/volumes/"),e(a)])]),E,n("p",null,[s("它所管理的Pod拥有固定的Pod名称，主机名，启停顺序 "),w,s("和 "),n("a",A,[s("Deployment"),e(a)]),s(" 类似， StatefulSet 管理基于相同容器规约的一组 Pod。但和 Deployment 不同的是， StatefulSet 为它们的每个 Pod 维护了一个有粘性的 ID。这些 Pod 是基于相同的规约来创建的， 但是不能相互替换：无论怎么调度，每个 Pod 都有一个永久不变的 ID。")]),n("p",null,[n("a",T,[s("https://kubernetes.io/zh-cn/docs/concepts/workloads/controllers/statefulset/"),e(a)])]),D,n("p",null,[n("a",I,[s("https://kubernetes.io/zh-cn/docs/concepts/storage/persistent-volumes/#access-modes"),e(a)])]),q,n("p",null,[n("a",F,[s("https://kubernetes.io/zh-cn/docs/concepts/storage/persistent-volumes/#reclaim-policy"),e(a)]),G]),W,n("p",null,[n("a",j,[s("https://kubernetes.io/zh-cn/docs/concepts/storage/persistent-volumes/#volume-mode"),e(a)])]),K,n("p",null,[n("a",L,[s("https://www.oracle.com/java/technologies/javase/javase8u211-later-archive-downloads.html#license-lightbox"),e(a)])]),Y])}const B=p(c,[["render",X],["__file","kubernetes-4.html.vue"]]);export{B as default};
