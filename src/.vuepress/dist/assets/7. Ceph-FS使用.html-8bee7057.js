import{_ as p,V as t,W as i,Y as n,Z as s,a0 as e,X as c,C as l}from"./framework-8eb1d601.js";const o={},d=n("p",null,[s("ceph FS即"),n("strong",null,"ceph filesystem"),s("，"),n("strong",null,"可以实现文件系统共享功能"),s("，客户端通过ceph协议挂载并使用ceph集群作为数据存储服务器。 （类似NFS）")],-1),r=n("strong",null,"Ceph FS需要运行Meta Data Services(MDS)服务",-1),u=n("strong",null,"ceph-mds",-1),m=n("strong",null,"ceph-mds",-1),h=n("br",null,null,-1),v=n("br",null,null,-1),b={href:"http://docs.ceph.org.cn/cephfs/",target:"_blank",rel:"noopener noreferrer"},k=n("br",null,null,-1),g=n("strong",null,"Ceph FS",-1),f=c(`<figure><img src="http://cdn1.ryanxin.live/xxlog/1670032830978-7c4700c6-742c-4c85-985c-303502b3c04a.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><figure><img src="http://cdn1.ryanxin.live/xxlog/1670031679816-4f17d48b-c55b-46da-8e2c-9bbc7c330469.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><figure><img src="http://cdn1.ryanxin.live/xxlog/1670031795634-590ba06c-1248-4907-9d35-816f5541eef7.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h2 id="_7-1-部署mds-服务" tabindex="-1"><a class="header-anchor" href="#_7-1-部署mds-服务" aria-hidden="true">#</a> 7.1 部署MDS 服务</h2><p>如果要使用cephFS,需要部署cephfs服务。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Ubuntu:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-2-创建cephfs-metadata和data存储池" tabindex="-1"><a class="header-anchor" href="#_7-2-创建cephfs-metadata和data存储池" aria-hidden="true">#</a> 7.2 创建CephFS metadata和data存储池</h2><p>使用<strong>CephFS</strong>之前需要事先于集群中创建一个文件系统，并为其分别指定元数据和数据相关的存储池。下面创建一一个名为<strong>cephfs</strong>的文件系统用于测试，它使用<strong>cephfs-metadata</strong>为元数据存储池，使用<strong>cephfs-data</strong> 为数据存储池。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#保存metadata的pool</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-3-创建cephfs并验证" tabindex="-1"><a class="header-anchor" href="#_7-3-创建cephfs并验证" aria-hidden="true">#</a> 7.3 创建cephFS并验证</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ ceph fs new mycephfs cephfs-metadata cephfs-data
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-4-验证cepffs服务状态" tabindex="-1"><a class="header-anchor" href="#_7-4-验证cepffs服务状态" aria-hidden="true">#</a> 7.4 验证cepfFS服务状态</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#现在已经转变为活动状态</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-5-创建客户端账户" tabindex="-1"><a class="header-anchor" href="#_7-5-创建客户端账户" aria-hidden="true">#</a> 7.5 创建客户端账户</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#创建账户</span>
...
<span class="token punctuation">[</span>client.yanyan<span class="token punctuation">]</span>
          ...
          caps mon <span class="token operator">=</span> <span class="token string">&quot;allow r&quot;</span>
          caps osd <span class="token operator">=</span> <span class="token string">&quot;allow rwx pool=cephfs-data&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-6-安装ceph客户端" tabindex="-1"><a class="header-anchor" href="#_7-6-安装ceph客户端" aria-hidden="true">#</a> 7.6 安装ceph客户端</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client3 ~<span class="token punctuation">]</span><span class="token comment"># yum install epel-release -y</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-7-同步客户端认证文件" tabindex="-1"><a class="header-anchor" href="#_7-7-同步客户端认证文件" aria-hidden="true">#</a> 7.7 同步客户端认证文件</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ <span class="token function">scp</span> ceph.conf ceph.client.yanyan.keyring yanyan.key root@172.31.6.203:/etc/ceph/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_7-8-客户端验证权限" tabindex="-1"><a class="header-anchor" href="#_7-8-客户端验证权限" aria-hidden="true">#</a> 7.8 客户端验证权限</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client3 ~<span class="token punctuation">]</span><span class="token comment"># ceph --user yanyan -s</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_7-9-内核空间挂载ceph-fs" tabindex="-1"><a class="header-anchor" href="#_7-9-内核空间挂载ceph-fs" aria-hidden="true">#</a> 7.9 内核空间挂载ceph-fs</h2><p>客户端挂载有两种方式，一是内核空间，二是用户空间,内核空间挂载需要内核支持ceph模块，用户空间挂载需要安装<strong>ceph-fuse。 内核&gt; 2.6.34默认支持ceph</strong></p><h3 id="_7-9-1-客户端通过key文件挂载" tabindex="-1"><a class="header-anchor" href="#_7-9-1-客户端通过key文件挂载" aria-hidden="true">#</a> 7.9.1 客户端通过key文件挂载</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@ceph-client3 ~<span class="token punctuation">]</span><span class="token comment"># mkdir /data</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://cdn1.ryanxin.live/xxlog/1670036201261-4009e08b-2948-4d04-947e-f09a08a3da8c.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="_7-9-2-客户端通过key挂载" tabindex="-1"><a class="header-anchor" href="#_7-9-2-客户端通过key挂载" aria-hidden="true">#</a> 7.9.2 客户端通过key挂载</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph-client3 ~<span class="token punctuation">]</span><span class="token comment"># tail /etc/ceph/yanyan.key</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-9-3-开机挂载" tabindex="-1"><a class="header-anchor" href="#_7-9-3-开机挂载" aria-hidden="true">#</a> 7.9.3 开机挂载</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@ceph-client3 ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/fstab </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-9-4-客户端模块" tabindex="-1"><a class="header-anchor" href="#_7-9-4-客户端模块" aria-hidden="true">#</a> 7.9.4 客户端模块</h3><p>客户端内核加载<strong>ceph.ko</strong>模块挂载<strong>cephfs</strong>文件系统<br><img src="http://cdn1.ryanxin.live/xxlog/1670038472628-cd3e7bdd-23a7-4238-b1ec-ff6dd9ff8445.png" alt="image.png" loading="lazy"></p><h2 id="_7-10-用户空间挂载ceph-fs" tabindex="-1"><a class="header-anchor" href="#_7-10-用户空间挂载ceph-fs" aria-hidden="true">#</a> 7.10 用户空间挂载ceph-fs</h2><p>如果内核本较低而没有ceph模块,那么可以安装<strong>ceph-fuse</strong> 挂载，但是推荐使用内核模块挂载。</p><h3 id="_7-10-1-安装ceph-fuse" tabindex="-1"><a class="header-anchor" href="#_7-10-1-安装ceph-fuse" aria-hidden="true">#</a> 7.10.1 安装ceph-fuse</h3>`,35),y={href:"http://docs.ceph.org.cn/man/8/ceph-fuse/",target:"_blank",rel:"noopener noreferrer"},_=n("br",null,null,-1),x=n("strong",null,"ceph-fuse",-1),S=c(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@ceph- client2 ~<span class="token punctuation">]</span><span class="token comment"># yum install epel-release -y</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-10-2-ceph-fuse-挂载" tabindex="-1"><a class="header-anchor" href="#_7-10-2-ceph-fuse-挂载" aria-hidden="true">#</a> 7.10.2 ceph-fuse 挂载</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#同步认证及配置文件: </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-11-ceph-mds高可用" tabindex="-1"><a class="header-anchor" href="#_7-11-ceph-mds高可用" aria-hidden="true">#</a> 7.11 ceph mds高可用</h2><p>基于多mds服务器，在业务高并发时频繁读写元数据的场景。 <br><strong>Ceph mds(etadata service)<strong>作为ceph的访问入口，需要实现高性能及数据备份，假设启动4个MDS进程，设置2个</strong>Rank</strong>.这时候有2个MDS进程会分配给两个Rank，还剩下2个MDS进程分别作为另外个的备份。</p><p><strong>通过参数指定那主的备是谁</strong><br>设置每个Rank的备份MDS,也就是如果此Rank当前的MDS出现问题马上切换到另个MDS，设置备份的方法有很多，常用选项如下。<br><code>mds_standby_replay</code>: 值为true或false, true 表示开启replay 模式，这种模式下主MDS内的数量将实时与从MDS同步，如果主宕机，从可以快速的切换，如果为false只有宕机的时候才去同步数据，这样会有一段时间的中断.<br><code>mds_standby_for_name</code>:设置当前MDS进程只用于备份于指定名称的MDS.<br><code>mds_standby_for_rank</code>: 设置当前MDS进程只用于备份于哪个Rank,通常为Rank编号<br>另外在存在之个CephFS文件系统中，还可以使用<code>mds_standby_for fscid</code> 参数来为指定不同的文件系统。<br><code>mds_standby_for fscid</code>: 指定CephFS文件系统ID,需要联合<code>mds_standby_for_rank</code>生效，如果设置<code>mds_standby_for_rank</code>, 那么就是用于指定文件系统的指定Rank,如果没有设置，就是指定文件系统的所有Rank。</p><h3 id="_7-11-1-当前mds服务器状态" tabindex="-1"><a class="header-anchor" href="#_7-11-1-当前mds服务器状态" aria-hidden="true">#</a> 7.11.1 当前mds服务器状态</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ ceph mds <span class="token function">stat</span>
mycephfs-1/1/1 up <span class="token punctuation">{</span><span class="token number">0</span><span class="token operator">=</span>ceph-mgr1<span class="token operator">=</span>up:active<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-11-2-添加mds服务器" tabindex="-1"><a class="header-anchor" href="#_7-11-2-添加mds服务器" aria-hidden="true">#</a> 7.11.2 添加MDS服务器</h3><p>将<strong>ceph-mgr2</strong>和<strong>ceph-mon2</strong>和<strong>ceph-mon3</strong>作为mds服务角色添加至ceph集群.<br>最后实现<strong>两主两备</strong>的mds高可用和高性能结构。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#mds服务器安装ceph-mds服务</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-11-3-验证ceph集群当前状态" tabindex="-1"><a class="header-anchor" href="#_7-11-3-验证ceph集群当前状态" aria-hidden="true">#</a> 7.11.3 验证ceph集群当前状态</h3><p>当前处于激活状态的mds服务器有一台，处于备份状态的mds服务器有三台.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ ceph fs status
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="http://cdn1.ryanxin.live/xxlog/1670041951106-d3c42f57-0357-4a1c-928e-088b46fdef38.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="_7-11-4-当前的文件系统状态" tabindex="-1"><a class="header-anchor" href="#_7-11-4-当前的文件系统状态" aria-hidden="true">#</a> 7.11.4 当前的文件系统状态</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ ceph fs get mycephfs
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-11-5-设置处于激活状态的mds的数量" tabindex="-1"><a class="header-anchor" href="#_7-11-5-设置处于激活状态的mds的数量" aria-hidden="true">#</a> 7.11.5 设置处于激活状态的mds的数量</h3><p>目前有四个mds服务器，但是有一个主三个备，可以优化一 下部署架构，设置为为两主两备</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ cepn fs <span class="token builtin class-name">set</span> mycephfs max_mds <span class="token number">2</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-11-6-mds高可用优化" tabindex="-1"><a class="header-anchor" href="#_7-11-6-mds高可用优化" aria-hidden="true">#</a> 7.11.6 MDS高可用优化</h3><p>目前的状态是<strong>ceph-mgr1</strong>和<strong>ceph-mon2</strong>分别是<strong>active</strong> 状态，<strong>ceph-mon3</strong> 和<strong>ceph-mgr2</strong>分别处于<strong>standby</strong>状态。<br>现在可以将ceph-mgr2设置为ceph-mgr1的standby,将ceph-mon3设置为ceph-mon2的standby,以实现每个主都有一个固定备份角色的结构，则修改配置文件如下:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>ceph@ceph-deploy ceph-cluster<span class="token punctuation">]</span>$ <span class="token function">vim</span> ceph.conf
...
mds_standby_replay <span class="token operator">=</span> <span class="token boolean">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-11-7-分发配置文件并重启mds服务" tabindex="-1"><a class="header-anchor" href="#_7-11-7-分发配置文件并重启mds服务" aria-hidden="true">#</a> 7.11.7 分发配置文件并重启mds服务</h3><p>#分发配置文件保证各mds服务重启有效</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ ceph-deploy --overwrite-conf config push ceph-mon3
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-11-8-ceph集群mds高可用状态" tabindex="-1"><a class="header-anchor" href="#_7-11-8-ceph集群mds高可用状态" aria-hidden="true">#</a> 7.11.8 ceph集群mds高可用状态</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>ceph fs status
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_7-12-通过ganesha将cephfs导出为nfs" tabindex="-1"><a class="header-anchor" href="#_7-12-通过ganesha将cephfs导出为nfs" aria-hidden="true">#</a> 7.12 通过ganesha将cephfs导出为NFS</h2><p>通过<strong>ganesha</strong>将<strong>cephfs</strong>通过<strong>NFS</strong>协议共享使用。</p>`,30),w={href:"https://www.server-world.info/en/note?os=Ubuntu_20.04&p=ceph15&f=8",target:"_blank",rel:"noopener noreferrer"},q=c(`<p>把Ceph Fs 中转成NFS协议<br><img src="http://cdn1.ryanxin.live/xxlog/1670053186530-4c6a1261-8e83-4b2c-bd94-a455b5411136.png" alt="image.png" loading="lazy"></p><h3 id="_7-12-1-服务端配置" tabindex="-1"><a class="header-anchor" href="#_7-12-1-服务端配置" aria-hidden="true">#</a> 7.12.1 服务端配置</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@ceph-mgr1:~<span class="token comment"># apt install nfs-ganesha-ceph</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-12-2-客户端挂载测试" tabindex="-1"><a class="header-anchor" href="#_7-12-2-客户端挂载测试" aria-hidden="true">#</a> 7.12.2 客户端挂载测试</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@ceph- client3-ubuntu1804:~<span class="token comment"># mount -t nfs 172.31.6.104:/magedu /data</span>
验证挂载:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function M(A,$){const a=l("ExternalLinkIcon");return t(),i("div",null,[d,n("p",null,[r,s("，其守护进程为"),u,s(", "),m,h,s("进程管理与Ceph FS上存储的文件相关的元数据，并协调对ceph存储集群的访问。"),v,n("a",b,[s("http://docs.ceph.org.cn/cephfs/"),e(a)]),k,g,s("的元数据使用的动态子树分区,把元数据划分名称空间对应到不同的mds,写入元数据的时候将元数据按照名称保存到不同主mds上，有点类似于nginx中的缓存目录分层一样。但是最终元数据都会保存在ceph 元数据池中。")]),f,n("p",null,[n("a",y,[s("http://docs.ceph.org.cn/man/8/ceph-fuse/"),e(a)]),_,s("在一台新的客户端或还原快照，然后安装"),x]),S,n("blockquote",null,[n("p",null,[n("a",w,[s("https://www.server-world.info/en/note?os=Ubuntu_20.04&p=ceph15&f=8"),e(a)])])]),q])}const F=p(o,[["render",M],["__file","7. Ceph-FS使用.html.vue"]]);export{F as default};
