...
// node_modules/mermaid/dist/mermaidAPI-a1a81019.js
var version = "10.0.0";
var id$i = "c4";
var detector$i = (txt) => {
...
var loader$i = async () => {
  const { diagram } = await import("./c4Diagram-2ae3841a-AYNN3A6B.js");
...
var loader$h = async () => {
  const { diagram } = await import("./flowDiagram-ee152de2-IUWFWF63.js");
...
var loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-566a30e4-MH4HXTGP.js");
...
var loader$f = async () => {
  const { diagram } = await import("./erDiagram-508b3995-R4KQERYR.js");
...
var loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-e326c88e-NLO5M7ZS.js");
...
var loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-18b8bb1d-GAD2QIOA.js");
...
var loader$c = async () => {
  const { diagram } = await import("./infoDiagram-cc60b1ac-6EFVB7AW.js");
...
var loader$b = async () => {
  const { diagram } = await import("./pieDiagram-00db3e06-NASK6W3N.js");
...
var loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-61f3cb14-QPCC4D4V.js");
...
var loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-2682829a-LC4BEIAW.js");
...
var loader$8 = async () => {
  const { diagram } = await import("./classDiagram-58722808-OOSZNGBO.js");
...
var loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-4cc74290-4APZPV57.js");
...
var loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-224b91ac-WOEYRDUV.js");
...
var loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-03fb723d-GQFI2ESF.js");
...
var loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-37931021-JXUX535W.js");
...
var loader$3 = async () => {
  const { diagram } = await import("./errorDiagram-c771b856-6BGLPKEW.js");
...
var loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-99086e81-B2OVQOFL.js");
...
var loader$1 = async () => {
  const { diagram } = await import("./timeline-definition-bc3d9443-MOCUWAPL.js");
...
var loader = async () => {
  const { diagram } = await import("./mindmap-definition-2a1985ac-O7Y2Y7BP.js");
  return { id, diagram };
};
var plugin = {
  id,
...
//# sourceMappingURL=chunk-AUPQ4PAP.js.map
