...
// node_modules/mermaid/dist/styles-bd38c0ff.js
var parser = function() {
...
var splitClassNameAndType = function(id) {
  ...
  if (id.indexOf("~") > 0) {
    let split = id.split("~");
    className = split[0];
    genericType = common.sanitizeText(split[1], getConfig());
  }
...
var cleanupLabel = function(label) {
  if (label.substring(0, 1) === ":") {
    return common.sanitizeText(label.substr(1).trim(), getConfig());
  } else {
...
//# sourceMappingURL=chunk-OWK6U4YZ.js.map
