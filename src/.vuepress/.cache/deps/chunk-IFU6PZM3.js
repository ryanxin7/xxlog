...
var loader$i = async () => {
  const { diagram } = await import("./c4Diagram-f9e67060-MBVBIAYN.js");
...
var loader$h = async () => {
  const { diagram } = await import("./flowDiagram-42bb1e4d-WQPN7DTZ.js");
...
var loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-4c9a7611-RR5GD5N4.js");
...
var loader$f = async () => {
  const { diagram } = await import("./erDiagram-25977acd-LDFY6A2Y.js");
...
var loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-30dcca6d-J6ILMTPX.js");
...
var loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-41439120-JQ5BKIXL.js");
...
var loader$c = async () => {
  const { diagram } = await import("./infoDiagram-1b335302-JH53EEZT.js");
...
var loader$b = async () => {
  const { diagram } = await import("./pieDiagram-905ac727-MMT347SF.js");
...
var loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-84e9ae78-ERS2BGOY.js");
...
var loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-2c95880e-BNDGKV3I.js");
...
var loader$8 = async () => {
  const { diagram } = await import("./classDiagram-4456d403-SIIKIDB4.js");
...
var loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-539b00ca-TLVY4CG4.js");
...
var loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-95825141-I37W5GMS.js");
...
var loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-1cc5d8ed-ZDVGDYSS.js");
...
var loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-ded66ec9-XJODJOEG.js");
...
var loader$3 = async () => {
  const { diagram } = await import("./errorDiagram-bb949655-NOU2CLG3.js");
...
var loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-c9fc5e04-37MZXIY3.js");
...
var loader$1 = async () => {
  const { diagram } = await import("./timeline-definition-24ebf147-PETQXR3C.js");
...
var loader = async () => {
  const { diagram } = await import("./mindmap-definition-c8a05b8a-BKN2A7BJ.js");
  return { id, diagram };
};
var plugin = {
  id,
...
//# sourceMappingURL=chunk-IFU6PZM3.js.map
