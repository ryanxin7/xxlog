...
// node_modules/mermaid/dist/utils-3cbdbddf.js
...
var parseDirective$1 = function(p, statement, context, type2) {
  log.debug("parseDirective is being called", statement, context, type2);
  try {
    if (statement !== void 0) {
...
var handleDirective = function(p, directive2, type2) {
  log.info(`Directive type=${directive2.type} with args:`, directive2.args);
  switch (directive2.type) {
    ...
    case "initialize": {
      ...
      log.info("sanitize in handleDirective", directive2.args);
      directiveSanitizer(directive2.args);
      log.info("sanitize in handleDirective (done)", directive2.args);
...
var sanitizeText2 = (text) => sanitizeText(text, getConfig2());
...
var diagrams = {};
var registerDiagram = (id, diagram, detector) => {
  if (diagrams[id]) {
...
var anyComment = /\s*%%.*\n/gm;
var detectors = {};
var detectType = function(text, config) {
...
var addDetector = (key, detector, loader2) => {
  if (detectors[key]) {
    log.error(`Detector with key ${key} already exists`);
  } else {
    detectors[key] = { detector, loader: loader2 };
  }
  log.debug(`Detector with key ${key} added${loader2 ? " with loader" : ""}`);
};
...
var detectInit = function(text, config) {
...
mermaid/dist/utils-3cbdbddf.js:
  (*! js-yaml 4.1.0 https://github.com/nodeca/js-yaml @license MIT *)
*/
//# sourceMappingURL=chunk-L3CNDGPF.js.map
