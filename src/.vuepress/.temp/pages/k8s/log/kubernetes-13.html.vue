...
<figure><img src="http://cdn1.ryanxin.live/1676516280565-5ee4d1cd-bc2d-4c5e-8973-b0fd7a8a7e98.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><a name="M29Y1"></a></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为之前创建的nginx pod访问量较低，cpul利用率肯定不超过80%，所以等待一段时间就会触发缩容  <br /><img src="http://cdn1.ryanxin.live/1676532911192-26193a95-e0a2-4179-bf88-8e266f44b84a.png" alt="" loading="lazy"></p>
<p>因为在hpa中定义的最小副本数为3，所以缩容到3个Pod就不会缩容了</p>
<figure><img src="http://cdn1.ryanxin.live/1676532937099-f0a2d6da-da9e-4509-a36d-da0886cc412d.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><a name="NH9Rb"></a></p>
