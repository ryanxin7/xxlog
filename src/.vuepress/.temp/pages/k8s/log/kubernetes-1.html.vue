...
<h2 id="_4-步骤1-基础环境初始化" tabindex="-1"><a class="header-anchor" href="#_4-步骤1-基础环境初始化" aria-hidden="true">#</a> 4.步骤1-基础环境初始化</h2>
...
<h2 id="_5-步骤2-部署etcd集群" tabindex="-1"><a class="header-anchor" href="#_5-步骤2-部署etcd集群" aria-hidden="true">#</a> 5.步骤2-部署etcd集群</h2>
...
<h2 id="_6-步骤3-部署运行时环境" tabindex="-1"><a class="header-anchor" href="#_6-步骤3-部署运行时环境" aria-hidden="true">#</a> 6.步骤3-部署运行时环境</h2>
...
<h3 id="_6-1-kubeasz-集成安装-containerd" tabindex="-1"><a class="header-anchor" href="#_6-1-kubeasz-集成安装-containerd" aria-hidden="true">#</a> 6.1 kubeasz 集成安装 containerd</h3>
...
<h3 id="_6-2-配置containerd-对接私有harbor仓库" tabindex="-1"><a class="header-anchor" href="#_6-2-配置containerd-对接私有harbor仓库" aria-hidden="true">#</a> 6.2 配置containerd 对接私有harbor仓库</h3>
<p>修改role模板文件</p>
...
<h3 id="_6-3-containerd-使用证书对接harbor实现上传下载" tabindex="-1"><a class="header-anchor" href="#_6-3-containerd-使用证书对接harbor实现上传下载" aria-hidden="true">#</a> 6.3 containerd 使用证书对接harbor实现上传下载</h3>
<p><a name="maN07"></a></p>
<h4 id="_6-3-1-使用脚本同步证书到客户端" tabindex="-1"><a class="header-anchor" href="#_6-3-1-使用脚本同步证书到客户端" aria-hidden="true">#</a> 6.3.1 使用脚本同步证书到客户端</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h4 id="_6-3-2-测试containerd-客户端使用证书登录harbor" tabindex="-1"><a class="header-anchor" href="#_6-3-2-测试containerd-客户端使用证书登录harbor" aria-hidden="true">#</a> 6.3.2 测试containerd 客户端使用证书登录harbor</h4>
...
<h2 id="_7-步骤4-部署master" tabindex="-1"><a class="header-anchor" href="#_7-步骤4-部署master" aria-hidden="true">#</a> 7.步骤4-部署master</h2>
...
<h2 id="_8-步骤5-部署node节点" tabindex="-1"><a class="header-anchor" href="#_8-步骤5-部署node节点" aria-hidden="true">#</a> 8.步骤5-部署node节点</h2>
...
<h2 id="_9-步骤6-部署网络组件" tabindex="-1"><a class="header-anchor" href="#_9-步骤6-部署网络组件" aria-hidden="true">#</a> 9.步骤6-部署网络组件</h2>
...
<p><a name="B2TM4"></a></p>
<h3 id="_9-1-使用calico网络组件" tabindex="-1"><a class="header-anchor" href="#_9-1-使用calico网络组件" aria-hidden="true">#</a> 9.1 使⽤calico⽹络组件</h3>
...
<h3 id="_9-2-验证calico网络" tabindex="-1"><a class="header-anchor" href="#_9-2-验证calico网络" aria-hidden="true">#</a> 9.2 验证calico网络</h3>
<p>执行calico安装成功后可以验证如下：(需要等待镜像下载完成，有时候即便上一步已经配置了docker国内加速，还是可能比较慢，请确认以下容器运行起来以后，再执行后续验证步骤)</p>
<p><a name="uSZT6"></a></p>
<h3 id="_9-3-查看所有calico节点状态" tabindex="-1"><a class="header-anchor" href="#_9-3-查看所有calico节点状态" aria-hidden="true">#</a> 9.3 查看所有calico节点状态</h3>
...
<h3 id="_9-4-创建容器测试网络通信" tabindex="-1"><a class="header-anchor" href="#_9-4-创建容器测试网络通信" aria-hidden="true">#</a> 9.4 创建容器测试网络通信</h3>
...
<h2 id="_10-步骤7-安装集群插件-coredns" tabindex="-1"><a class="header-anchor" href="#_10-步骤7-安装集群插件-coredns" aria-hidden="true">#</a> 10.步骤7-安装集群插件-coredns</h2>
<p>DNS 是 k8s 集群首要部署的组件，它为集群中的其他 pods 提供域名解析服务；主要可以解析 集群服务名 SVC 和 Pod hostname；目前建议部署 coredns。</p>
<p><a name="HM66U"></a></p>
<h3 id="_10-1-下载二进制包" tabindex="-1"><a class="header-anchor" href="#_10-1-下载二进制包" aria-hidden="true">#</a> 10.1 下载二进制包</h3>
...
<h3 id="_10-2-修改配置文件" tabindex="-1"><a class="header-anchor" href="#_10-2-修改配置文件" aria-hidden="true">#</a> 10.2 修改配置文件</h3>
...
<p><a name="lxLe9"></a></p>
<h3 id="_10-3-下载镜像并推送到harbor" tabindex="-1"><a class="header-anchor" href="#_10-3-下载镜像并推送到harbor" aria-hidden="true">#</a> 10.3 下载镜像并推送到harbor</h3>
...
<h3 id="_10-4-安装coredns" tabindex="-1"><a class="header-anchor" href="#_10-4-安装coredns" aria-hidden="true">#</a> 10.4 安装coredns</h3>
...
<h3 id="_10-5-启动容器测试域名解析" tabindex="-1"><a class="header-anchor" href="#_10-5-启动容器测试域名解析" aria-hidden="true">#</a> 10.5 启动容器测试域名解析</h3>
...
<h3 id="_10-6-测试-prometheus-监控项" tabindex="-1"><a class="header-anchor" href="#_10-6-测试-prometheus-监控项" aria-hidden="true">#</a> 10.6 测试 prometheus 监控项</h3>
...
<p><a name="qCMg3"></a></p>
<h2 id="_11-步骤8-安装集群插件-dashboard" tabindex="-1"><a class="header-anchor" href="#_11-步骤8-安装集群插件-dashboard" aria-hidden="true">#</a> 11. 步骤8-安装集群插件-dashboard</h2>
...
<a name="JL93f"></a></p>
<h3 id="_11-1-下载对应kubernetes版本的dashboard" tabindex="-1"><a class="header-anchor" href="#_11-1-下载对应kubernetes版本的dashboard" aria-hidden="true">#</a> 11.1 下载对应kubernetes版本的dashboard</h3>
...
<h3 id="_11-2-修改service暴露方式" tabindex="-1"><a class="header-anchor" href="#_11-2-修改service暴露方式" aria-hidden="true">#</a> 11.2 修改service暴露方式</h3>
...
<h3 id="_11-3-下载镜像推送到harbor" tabindex="-1"><a class="header-anchor" href="#_11-3-下载镜像推送到harbor" aria-hidden="true">#</a> 11.3 下载镜像推送到harbor</h3>
...
<h3 id="_11-4-修改镜像地址" tabindex="-1"><a class="header-anchor" href="#_11-4-修改镜像地址" aria-hidden="true">#</a> 11.4 修改镜像地址</h3>
...
<h3 id="_11-5-安装dashboard组件" tabindex="-1"><a class="header-anchor" href="#_11-5-安装dashboard组件" aria-hidden="true">#</a> 11.5 安装dashboard组件</h3>
...
<h3 id="_11-6-查看组件运行状态" tabindex="-1"><a class="header-anchor" href="#_11-6-查看组件运行状态" aria-hidden="true">#</a> 11.6 查看组件运行状态</h3>
...
<h3 id="_11-7-获取登陆-token" tabindex="-1"><a class="header-anchor" href="#_11-7-获取登陆-token" aria-hidden="true">#</a> 11.7 获取登陆 token</h3>
...
<p><a name="LVYtG"></a></p>
<h3 id="_11-8-登录测试" tabindex="-1"><a class="header-anchor" href="#_11-8-登录测试" aria-hidden="true">#</a> 11.8 登录测试</h3>
...
<figure><img src="http://cdn1.ryanxin.live/1672820388726-cab07cf9-cbb9-4db3-bb1d-ef6ecfab21ff.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure>
<p><a name="F03jb"></a></p>
<h2 id="_12-集群管理" tabindex="-1"><a class="header-anchor" href="#_12-集群管理" aria-hidden="true">#</a> 12. 集群管理</h2>
<p>集群管理主要是添加master、添加node、删除master与删除node等节点管理及监控</p>
<p><a name="K5WEr"></a></p>
<h3 id="_12-1-添加node节点" tabindex="-1"><a class="header-anchor" href="#_12-1-添加node节点" aria-hidden="true">#</a> 12.1 添加node节点</h3>
...
<h3 id="_12-2-添加master-节点" tabindex="-1"><a class="header-anchor" href="#_12-2-添加master-节点" aria-hidden="true">#</a> 12.2 添加master 节点</h3>
...
<h3 id="_12-3-验证当前节点" tabindex="-1"><a class="header-anchor" href="#_12-3-验证当前节点" aria-hidden="true">#</a> 12.3 验证当前节点</h3>
...
<h2 id="_13-集群升级" tabindex="-1"><a class="header-anchor" href="#_13-集群升级" aria-hidden="true">#</a> 13. 集群升级</h2>
<p>先升级master 保证集群中至少有一个master节点可用 ，在node节点nginx反向代理中注释掉要升级的master节点。</p>
<figure><img src="http://cdn1.ryanxin.live/1672892592550-0602394c-6d2e-4912-b773-459e3460253a.jpg" alt="1672892592550-0602394c-6d2e-4912-b773-459e3460253a" tabindex="0" loading="lazy"><figcaption>1672892592550-0602394c-6d2e-4912-b773-459e3460253a</figcaption></figure>
<p><a name="ZaisC"></a></p>
<h3 id="_13-1-升级master节点" tabindex="-1"><a class="header-anchor" href="#_13-1-升级master节点" aria-hidden="true">#</a> 13.1 升级master节点</h3>
...
<p><a name="z1OjH"></a></p>
<h3 id="_13-2-升级node节点" tabindex="-1"><a class="header-anchor" href="#_13-2-升级node节点" aria-hidden="true">#</a> 13.2 升级node节点</h3>
