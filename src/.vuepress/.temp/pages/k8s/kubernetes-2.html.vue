<template><div><p>etcd是CoreOS团队于2013年6月发起的开源项目，它的目标是构建一个高可用的分 布式键值(key-value)数据库。etcd内部采用raft协议作为-致性算法，etcd基于Go语言实现。</p>
<p>官方网站：<a href="https://etcd.io" target="_blank" rel="noopener noreferrer">https://etcd.io<ExternalLinkIcon/></a><br />github地址: <a href="https://github.com/etcd-io/etcd" target="_blank" rel="noopener noreferrer">https://github.com/etcd-io/etcd<ExternalLinkIcon/></a><br />官方硬件推荐：<a href="https://etcd.io/docs/v3.4/op-guide/hardware/" target="_blank" rel="noopener noreferrer">https://etcd.io/docs/v3.4/op-guide/hardware/<ExternalLinkIcon/></a></p>
<p>为什么k8s使用etcd？ <br /><strong>Etcd 特有优势</strong></p>
<blockquote>
<p><strong>完全复制:</strong> 集群中的每个节点都可以使用完整的存档<br /><strong>高可用性</strong>:  Etcd可用于避免硬件的单点故障或网络问题<br /><strong>一致性</strong>: 每次读取都会返回跨多主机的最新写入<br /><strong>简单</strong>: 包括一个定义良好、面向用户的API (gRPC)<br /><strong>安全</strong>: 实现了带有可选的客户端证书身份验证的自动化TLS<br /><strong>快速</strong>: 每秒10000次写入的基准速度<br /><strong>可靠</strong>: 使用Raft算法实现了存储的合理分布Etcd的工作原理</p>
</blockquote>
<p>etcd 存储这k8s整个集群的数据，一定要做好定期备份</p>
<p>因为etcd数据存储在硬盘上，读写IO速度关系着集群中pod的运行，etcd集群最好使用固态硬盘并且内存要大一点。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>中间件：
复制式集群
   mysql 集群 zookeeper etcd redis 哨兵
 
分片式：
   redis cluster kafka elasticsearch
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>启动脚本参数:</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root@k8s-etcd1:-<span class="token comment"># cat /etc/systemd/system/etcd. service</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="VCN6E"></a></p>
<h3 id="验证当前etcd所有成员状态" tabindex="-1"><a class="header-anchor" href="#验证当前etcd所有成员状态" aria-hidden="true">#</a> 验证当前etcd所有成员状态</h3>
<p><a name="oXhMz"></a></p>
<h4 id="_1-心跳信息" tabindex="-1"><a class="header-anchor" href="#_1-心跳信息" aria-hidden="true">#</a> 1.心跳信息</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#export NODE_IPS="172.31.7.101 172.31.7.102 172.31.7.103"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="j1SDg"></a></p>
<h4 id="_2-显示集群成员信息" tabindex="-1"><a class="header-anchor" href="#_2-显示集群成员信息" aria-hidden="true">#</a> 2. 显示集群成员信息</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">ETCDCTL_API</span><span class="token operator">=</span><span class="token number">3</span> /usr/local/bin/etcdctl --write-out<span class="token operator">=</span>table member list   <span class="token parameter variable">--endpoints</span><span class="token operator">=</span>https://172.31.7.101:2379 <span class="token parameter variable">--cacert</span><span class="token operator">=</span>/etc/kubernetes/ssl/ca.pem   <span class="token parameter variable">--cert</span><span class="token operator">=</span>/etc/kubernetes/ssl/etcd.pem <span class="token parameter variable">--key</span><span class="token operator">=</span>/etc/kubernetes/ssl/etcd-key.pem
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><a name="tfn5J"></a></p>
<h4 id="_3-以表格方式显示节点详细状态" tabindex="-1"><a class="header-anchor" href="#_3-以表格方式显示节点详细状态" aria-hidden="true">#</a> 3.以表格方式显示节点详细状态</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">export</span> <span class="token assign-left variable">NODE_IPS</span><span class="token operator">=</span><span class="token string">"172.31.7.101 172.31.7.102 172.31.7.103"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="oGjHS"></a></p>
<h2 id="查看etcd数据信息" tabindex="-1"><a class="header-anchor" href="#查看etcd数据信息" aria-hidden="true">#</a> 查看etcd数据信息</h2>
<p>查看etcd集群中保存的数据
<a name="HBd80"></a></p>
<h3 id="_1-查看所有key" tabindex="-1"><a class="header-anchor" href="#_1-查看所有key" aria-hidden="true">#</a> 1.查看所有key</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="JbVo3"></a></p>
<h3 id="_2-查看指定key" tabindex="-1"><a class="header-anchor" href="#_2-查看指定key" aria-hidden="true">#</a> 2.查看指定key</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root@etcd01:~<span class="token comment"># ETCDCTL_API=3 etcdctl get /calico/ipam/v2/assignment/ipv4/block/10.20.241.64-26</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="nqwmr"></a></p>
<h3 id="_3-查看所有calico的数据" tabindex="-1"><a class="header-anchor" href="#_3-查看所有calico的数据" aria-hidden="true">#</a> 3.查看所有calico的数据</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root@etcd01:~<span class="token comment"># ETCDCTL_API=3 etcdctl get /calico --keys-only --prefix | grep calico</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><a name="z2OjX"></a></p>
<h3 id="etcd增删改查数据" tabindex="-1"><a class="header-anchor" href="#etcd增删改查数据" aria-hidden="true">#</a> etcd增删改查数据</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#添加数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="RnsDa"></a></p>
<h2 id="etcd数据watch机制" tabindex="-1"><a class="header-anchor" href="#etcd数据watch机制" aria-hidden="true">#</a> etcd数据watch机制</h2>
<p>基于不断监看数据，发生变化就主动触发通知客户端，Etcd v3 的watch机制支持watch某个固定的key，也支持watch一个范围。</p>
<p>在etcd node1上watch一个key  ，在etcdnode2修改数据，验证etcdnode1是否能够发现数据变化</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root@etcd02:~<span class="token comment"># etcdctl put /data/name xin123</span>
OK
root@etcd01:~<span class="token comment"># etcdctl watch /data/name </span>
PUT
/data/name
xin123
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="dmxFs"></a></p>
<h2 id="etcd-数据手动备份与恢复" tabindex="-1"><a class="header-anchor" href="#etcd-数据手动备份与恢复" aria-hidden="true">#</a> etcd 数据手动备份与恢复<br /><br /></h2>
<p>WAL是<strong>write ahead log</strong>的缩写，顾名思义，也就是在执行真正的写操作之前先写一个日志，预写日志。<br /><strong>wal</strong>: 存放预写式日志,最大的作用是记录了整个数据变化的全部历程。<br />在etcd中，所有数据的修改在提交前，都要先写入到WAL中。
<a name="tChBx"></a></p>
<h3 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a> <br /></h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#V3版本备份数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="Yzl4t"></a></p>
<h3 id="使用kubeasz-备份与恢复数据" tabindex="-1"><a class="header-anchor" href="#使用kubeasz-备份与恢复数据" aria-hidden="true">#</a> 使用kubeasz 备份与恢复数据</h3>
<p><strong>恢复数据期间master 节点 <strong>kube-apiserver/scheduler/controller-manager 服务</strong>不可用</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>./ezctl backup k8s-01

kubectl delete pod net-test1

./ezctl restore k8s-01
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="NFIJJ"></a></p>
<h3 id="etcd-数据恢复流程" tabindex="-1"><a class="header-anchor" href="#etcd-数据恢复流程" aria-hidden="true">#</a> ETCD 数据恢复流程</h3>
<p>当etcd集群宕机数量超过集群总节点数一半以上的时候(如总数为三台宕机两台)，就会导致整合集群宕机，后期需要重新恢复数据，则恢复流程如下:</p>
<ol>
<li>恢复服务器系统</li>
<li>重新部署ETCD集群</li>
<li>停止<code v-pre>kube-apiserver/controller-manager/scheduler/kubelet/kube-proxy</code></li>
<li>停止ETCD集群</li>
<li>各ETCD节点恢复同一份备份数据</li>
<li>启动各节点并验证ETCD集群</li>
<li>启动<code v-pre>kube-apiserver/controller-manager/scheduler/kubelet/kube-proxy</code></li>
