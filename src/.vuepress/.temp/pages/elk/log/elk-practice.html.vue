<template><div><p>在等保2.0 测评单位对业务系统进行评测后，给出整改意见中提出：</p>
...
<!-- more -->
<h1 id="搭建elk平台收集各系统日志" tabindex="-1"><a class="header-anchor" href="#搭建elk平台收集各系统日志" aria-hidden="true">#</a> 搭建ELK平台收集各系统日志</h1>
...
<p>因为日志量不大所以使用四台服务器搭建ELK，部署情况如下：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>192.168.10.106  部署ES + head 插件 用来处理日志数据
...
<h2 id="rsyslog-部署" tabindex="-1"><a class="header-anchor" href="#rsyslog-部署" aria-hidden="true">#</a> Rsyslog 部署</h2>
<p>rsyslog用于收集对端系统的日志推送</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#替换源</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/rsyslog.png" alt="rsyslog" tabindex="0" loading="lazy"><figcaption>rsyslog</figcaption></figure>
<br>
<h3 id="对端深信服防火墙配置" tabindex="-1"><a class="header-anchor" href="#对端深信服防火墙配置" aria-hidden="true">#</a> 对端深信服防火墙配置</h3>
<p><code v-pre>版本号：AF 8.0.45</code></p>
<p>在监控—&gt; 日志—&gt;设置 中开启行为审计日志选项，配置对端syslog服务器地址和端口号。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119143240455.png" alt="image-20211119143240455" tabindex="0" loading="lazy"><figcaption>image-20211119143240455</figcaption></figure>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119142929809.png" alt="image-20211119142929809" tabindex="0" loading="lazy"><figcaption>image-20211119142929809</figcaption></figure>
<br>
<h3 id="对端深信服ssl-vpn配置" tabindex="-1"><a class="header-anchor" href="#对端深信服ssl-vpn配置" aria-hidden="true">#</a> 对端深信服SSL VPN配置</h3>
<p><code v-pre>版本号： SSL 7.6.9R1</code></p>
<p>在系统设置—&gt; 系统配置—&gt; 数据中心中启用Syslog 设置添加对端服务器地址</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119143328696.png" alt="image-20211119143328696" tabindex="0" loading="lazy"><figcaption>image-20211119143328696</figcaption></figure>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119143710182.png" alt="image-20211119143710182" tabindex="0" loading="lazy"><figcaption>image-20211119143710182</figcaption></figure>
<p>点击测试连通性测试对端服务器连接状况</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119143907307.png" alt="image-20211119143907307" tabindex="0" loading="lazy"><figcaption>image-20211119143907307</figcaption></figure>
<p>设置日志输出类型，注意根据实际需求选择相应日志等级，避免不必要的资源浪费。</p>
<h3 id="对端h3c核心交换机配置" tabindex="-1"><a class="header-anchor" href="#对端h3c核心交换机配置" aria-hidden="true">#</a> 对端H3C核心交换机配置</h3>
<p><code v-pre>设备型号：H3C S7503E-M </code></p>
<p><a href="https://www.h3c.com/cn/d_202109/1466386_30005_0.htm" target="_blank" rel="noopener noreferrer">详情见交换机配置手册-15-信息中心配置-新华三集团-H3C<ExternalLinkIcon/></a></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[Intranet-CSW-S7503E]info-center enable 
#开启信息中心
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119144942011.png" alt="image-20211119144942011" tabindex="0" loading="lazy"><figcaption>image-20211119144942011</figcaption></figure>
<p>由于系统对各方向允许输出的日志信息的缺省情况不一样，所以配置前必须将所有模块的需求方向（本例为loghost）上日志信息的输出开关关闭，再根据当前的需求配置输出规则，以免输出太多不需要的信息。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119150315381.png" alt="image-20211119150315381" tabindex="0" loading="lazy"><figcaption>image-20211119150315381</figcaption></figure>
<br>
<p>完成对端设备日志的推送设置后，相关日志保存在109本地服务器对应目录下的。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119151217426.png" alt="image-20211119151217426" tabindex="0" loading="lazy"><figcaption>image-20211119151217426</figcaption></figure>
<p>可见 防火墙日志中记录了之前在服务器中指定收集的日志类型</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119151333025.png" alt="image-20211119151333025" tabindex="0" loading="lazy"><figcaption>image-20211119151333025</figcaption></figure>
<p>至此rsyslog收集工作结束</p>
<h2 id="filebeat-组件配置" tabindex="-1"><a class="header-anchor" href="#filebeat-组件配置" aria-hidden="true">#</a> Filebeat 组件配置</h2>
<p><strong>环境变量配置</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">vim</span> /etc/profile.d/filebeat.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>经过配置rsyslog服务，已经收集到了各业务系统的日志文件，下一步工作就是收集到的文件通过ELK中的Filebeat组件对日志进行初步加工。</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment">#编辑配置文件</span>
...
<h3 id="filebeat-组件排错方法" tabindex="-1"><a class="header-anchor" href="#filebeat-组件排错方法" aria-hidden="true">#</a> Filebeat 组件排错方法</h3>
<p>在发生错误时，服务仍在运行状态时使用<code v-pre>systemctl status filebeat</code> 能看到的错误信息很少，通过前端手动指定运行日志的方式更易于问题的定位。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>filebeat <span class="token parameter variable">-c</span> /etc/filebeat/filebeat.yml <span class="token parameter variable">-path.home</span> /usr/share/filebeat <span class="token parameter variable">-path.config</span> /etc/filebeat <span class="token parameter variable">-path.data</span> /var/lib/filebeat <span class="token parameter variable">-path.logs</span> /var/log/filebeat
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119155142314.png" alt="image-20211119155142314" tabindex="0" loading="lazy"><figcaption>image-20211119155142314</figcaption></figure>
<br>
<h3 id="logstash-组件配置" tabindex="-1"><a class="header-anchor" href="#logstash-组件配置" aria-hidden="true">#</a> Logstash 组件配置</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>生成配置文件</strong></p>
<p>以命令行的方式来进行启动太繁琐，我们最好还是以配置文件的方式来进行服务的启动管理，对于 logstash来说，它提供好了一个专门用于生成配置文件的命令 system-install，我们只需要按照既定的 配置文件规则，定制应用配置，最后执行该命令，即可实现服务脚本的配置。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#进入应用目录</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#以root用户执行下面的命令</span>
system-install
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>日志在经过filebeat组件的初步改造，将各系统收集到的日志打上了type类型，Logstash根据类型创建不同的索引文件。这里通过grok插件对日志进行了字段自定义改造。以便后续在kibana中更好的绘图展示。<a href="http://localhost:4000/2021/10/21/Grok-patterns/" target="_blank" rel="noopener noreferrer">详情见 grok插件用法<ExternalLinkIcon/></a></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">vim</span> /etc/logstash/conf.d/logstash.conf
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>重载服务
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#查看日志：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>通过head插件查看数据传递效果</strong></p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119161952112.png" alt="image-20211119161952112" tabindex="0" loading="lazy"><figcaption>image-20211119161952112</figcaption></figure>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119162040416.png" alt="SSL VPN日志索引" tabindex="0" loading="lazy"><figcaption>SSL VPN日志索引</figcaption></figure>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119162131164.png" alt="防火墙日志索引" tabindex="0" loading="lazy"><figcaption>防火墙日志索引</figcaption></figure>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211119162152721.png" alt="交换机日志索引" tabindex="0" loading="lazy"><figcaption>交换机日志索引</figcaption></figure>
</div></template>
