...
<br>
<br>
<h2 id="keepalived-高可用服务部署-1" tabindex="-1"><a class="header-anchor" href="#keepalived-高可用服务部署-1" aria-hidden="true">#</a> Keepalived 高可用服务部署</h2>
<p>第一步：确认反向代理服务是否工作正常
在kl1和kl02服务器上测试web服务器是否可以正常
（最好有3台反向代理功能的Web服务器）</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>curl -H host:www.rxinxin.org 192.168.10.10/webserver.html
curl -H host:www.rxinxin.org 192.168.10.11/webserver.html
curl -H host:www.rxinxin.org 192.168.10.11/webserver.html
systemctl enable mariadb
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第二步：在浏览器上测试访问kl1和kl2 域名</p>
<p>解析hosts文件，将域名解析为192.168.10.20，进行测试访问
解析hosts文件，将域名解析为192.168.10.30，进行测试访问</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>测试前同步kl1和kl2的 Nginx 配置文件
...
<p>kl2备 负载均衡器配置</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>global_defs {
router_id kl2
       }
vrrp_instance klg1 {
state BACKUP
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="部署高可用服务时遇到的问题" tabindex="-1"><a class="header-anchor" href="#部署高可用服务时遇到的问题" aria-hidden="true">#</a> 部署高可用服务时遇到的问题</h3>
...
<br>
  <br>
<h3 id="利用shell脚本实现监控管理" tabindex="-1"><a class="header-anchor" href="#利用shell脚本实现监控管理" aria-hidden="true">#</a> 利用shell脚本实现监控管理</h3>
...
<h3 id="nginx反向代理监听虚拟ip地址" tabindex="-1"><a class="header-anchor" href="#nginx反向代理监听虚拟ip地址" aria-hidden="true">#</a> Nginx反向代理监听虚拟IP地址</h3>
<ol>
<li>编写nginx反向代理配置</li>
</ol>
...
<br>
<h3 id="将高可用和反向代理服务建立联系" tabindex="-1"><a class="header-anchor" href="#将高可用和反向代理服务建立联系" aria-hidden="true">#</a> 将高可用和反向代理服务建立联系</h3>
...
<br>
<h3 id="实现高可用集群架构中双主配置-互为主备配置" tabindex="-1"><a class="header-anchor" href="#实现高可用集群架构中双主配置-互为主备配置" aria-hidden="true">#</a> 实现高可用集群架构中双主配置（互为主备配置）</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>  kl2
vrrp_instance klg1 {
  state BACKUP
  interface eth0
  virtual_router_id 31
