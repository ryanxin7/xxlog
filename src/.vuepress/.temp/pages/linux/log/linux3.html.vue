<template><div><h1 id="keepalived-高可用服务部署" tabindex="-1"><a class="header-anchor" href="#keepalived-高可用服务部署" aria-hidden="true">#</a> Keepalived 高可用服务部署</h1>
...
<h2 id="一、keepalived-软件工作原理" tabindex="-1"><a class="header-anchor" href="#一、keepalived-软件工作原理" aria-hidden="true">#</a> 一、Keepalived 软件工作原理</h2>
<p>​</p>
<p>启初 VRRP 的出现是为了解决静态路由的单点故障。VRRP 是用过IP多播的方式实现高可用对之间通信的。工作时主服务器节点发包，备服务器节点接包，当备服务器节点接收不到主服务器节点发的数据包的时候，就启动接管程序接管主服务器节点的资源。备服务器节点可以有多个，通过优先级竞选。优先级数值越大优先级越大。</p>
<h2 id="二、keepalived-高可用服务部署" tabindex="-1"><a class="header-anchor" href="#二、keepalived-高可用服务部署" aria-hidden="true">#</a> 二、Keepalived 高可用服务部署</h2>
<h3 id="_1-确认反向代理服务是否工作正常" tabindex="-1"><a class="header-anchor" href="#_1-确认反向代理服务是否工作正常" aria-hidden="true">#</a> 1.确认反向代理服务是否工作正常</h3>
<p>在kl1和kl02服务器上测试web服务器是否可以正常（最好有3台反向代理功能的Web服务器）</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>  <span class="token function">curl</span> <span class="token parameter variable">-H</span> host:www.rxinxin.org <span class="token number">192.168</span>.10.10/webserver.html
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-在浏览器上测试访问kl1和kl2-域名" tabindex="-1"><a class="header-anchor" href="#_2-在浏览器上测试访问kl1和kl2-域名" aria-hidden="true">#</a> 2.在浏览器上测试访问kl1和kl2 域名</h3>
<p>解析hosts文件，将域名解析为192.168.10.20，进行测试访问</p>
<p>解析hosts文件，将域名解析为192.168.10.30，进行测试访问</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>测试前同步kl1和kl2的 Nginx 配置文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、安装-keepalived-服务软件" tabindex="-1"><a class="header-anchor" href="#三、安装-keepalived-服务软件" aria-hidden="true">#</a> 三、安装 Keepalived 服务软件</h2>
<p>第一步：安装软件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>第二步：编写keepalived配置文件</p>
...
<div class="language-bashba line-numbers-mode" data-ext="bashba"><pre v-pre class="language-bashba"><code>GLOBAL CONFIGURATION  --- 全局配置
...
<p>脑裂情况出现原因：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>  1. 心跳线出现问题
     网卡配置有问题
     交换设备有问题
     线缆连接有问题
  2. 有防火墙软件阻止问题
  3. virtual_router_id
     配置数值不正确  
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>总之：只要备服务器收不到主服务器发出的组播包，就会成为主服务器，而主服务器资源没有释放，备服务器要篡位就会出现脑裂。</p>
<h2 id="五、利用shell脚本实现监控管理" tabindex="-1"><a class="header-anchor" href="#五、利用shell脚本实现监控管理" aria-hidden="true">#</a> 五、利用shell脚本实现监控管理</h2>
...
<p><code v-pre>echo 'net.ipv4.ip_nonlocal_bind = 1' &gt;&gt;/etc/sysctl.conf 更改内核</code></p>
<p><code v-pre>sysctl -p</code></p>
<h2 id="七、将高可用和反向代理服务建立联系" tabindex="-1"><a class="header-anchor" href="#七、将高可用和反向代理服务建立联系" aria-hidden="true">#</a> 七、将高可用和反向代理服务建立联系</h2>
<p>因为Nginx 反向代理服务处于异常状态下，keepalived服务并没有从主服务器切换到备服务器，所以客户访问网站时反向代理服务一直处于挂了的异常状态导致网站无法正常访问。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.运行脚本，实现监控nginx服务</p>
<p>编辑keepalived服务配置文件</p>
<div class="language-vrrp_script line-numbers-mode" data-ext="vrrp_script"><pre v-pre class="language-vrrp_script"><code>#定义一个监控脚本，脚本必须有执行权限
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>chmod +x check_kls.sh   给予脚本可执行权限</p>
<h2 id="八、实现高可用集群架构中双主配置" tabindex="-1"><a class="header-anchor" href="#八、实现高可用集群架构中双主配置" aria-hidden="true">#</a> 八、实现高可用集群架构中双主配置</h2>
<p><strong>互为主备配置配置</strong></p>
<p>由于企业实际环境，很少等主服务器挂掉才调用备服务器，所以会将Web服务分配给两节点或多个集群并行使用节约成本。</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>kl1
vrrp_instance klg1 {
 state MASTER
 interface eth0
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>  kl2
vrrp_instance klg1 <span class="token punctuation">{</span>
  state BACKUP
  interface eth0
  virtual_router_id <span class="token number">31</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后修改 Nginx 反向代理服务配置文件的监听IP地址信息 完成对 Keepalived 互为主备节点的配置部署。</p>
</div></template>
