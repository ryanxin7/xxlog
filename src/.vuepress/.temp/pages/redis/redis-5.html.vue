<template><div><h1 id="redis-持久复制" tabindex="-1"><a class="header-anchor" href="#redis-持久复制" aria-hidden="true">#</a> Redis 持久复制</h1>
...
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/redis-RDB.jpg" alt="redis-RDB" tabindex="0" loading="lazy"><figcaption>redis-RDB</figcaption></figure>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/redis-RDB2.jpg" alt="redis-RDB2" tabindex="0" loading="lazy"><figcaption>redis-RDB2</figcaption></figure>
<br>
<h3 id="aof-原理" tabindex="-1"><a class="header-anchor" href="#aof-原理" aria-hidden="true">#</a> <strong>AOF 原理</strong></h3>
<p>AOF 以协议文本的方式，将所有对数据库进行过写入的命令（及其参数）记录到 AOF 文件，以此达到记录数据库状态的目的。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/redis-AOF.jpg" alt="redis-AOF" tabindex="0" loading="lazy"><figcaption>redis-AOF</figcaption></figure>
<br>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>rdb
	优势：
        - 基于数据的快照来进行存储
        - 数据完整
        - 策略非常灵活
...
<h4 id="rdb-实践" tabindex="-1"><a class="header-anchor" href="#rdb-实践" aria-hidden="true">#</a> RDB 实践</h4>
<p>RDB配置解析</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>自动保存机制
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 数据同步操作，执行时候，会导致其他命令无法执行</span>
...
since<span class="token punctuation">:</span> <span class="token number">1.0</span><span class="token number">.0</span>
group<span class="token punctuation">:</span> server
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>简单测试</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 执行备份前查看效果</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root@python-auto:~<span class="token comment"># grep -Env '#|^$' /etc/redis/redis.conf</span>
<span class="token punctuation">..</span>.
...
<p>AOF持久化命令</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 数据同步操作，执行时候，会导致其他命令无法执行</span>
...
<p>简单测试</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 检查现状</span>
