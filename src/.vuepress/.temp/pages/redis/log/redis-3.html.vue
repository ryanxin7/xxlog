<template><div><h1 id="redis-基础知识" tabindex="-1"><a class="header-anchor" href="#redis-基础知识" aria-hidden="true">#</a> Redis 基础知识</h1>
...
提供了 九种+ 的数据结构。</p>
<p>支持各种功能
- 复制、内部检测、事务操作、数据持久化、高可用功能(高可用、高扩展)</p>
<p><strong>趋势</strong>：</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/Redis趋势图1.jpg" alt="Redis趋势图1" tabindex="0" loading="lazy"><figcaption>Redis趋势图1</figcaption></figure>
<br>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/Redis趋势图2.jpg" alt="Redis趋势图2" tabindex="0" loading="lazy"><figcaption>Redis趋势图2</figcaption></figure>
<p>资料来源：<a href="https://db-engines.com/en/ranking/key-value+store/all" target="_blank" rel="noopener noreferrer">https://db-engines.com/en/ranking/key-value+store/all<ExternalLinkIcon/></a></p>
<br>
<h2 id="应用场景" tabindex="-1"><a class="header-anchor" href="#应用场景" aria-hidden="true">#</a> 应用场景</h2>
<p>我们直接从几种数据本身的应用特性来描述一下该软件的应用场景：</p>
<ul>
<li>
<p>Sort Set (有序集合)</p>
<p>有序集合在普通集合的基础上做了分数比较的特性，所以主要用来做一些分类排序等功能</p>
<p>比如：排行榜应用，取 top n 操作</p>
</li>
<li>
<p>List (列表)</p>
<p>列表本身具有排序、切片等特性，因为redis的基于内存的分布式特性，它主要来做一些数据筛选、排序等功能</p>
<p>比如：获得最新 N 个数据 或 某个分类的最新数据等</p>
</li>
<li>
<p>String (字符串)</p>
<p>字符串的其实就是数据的临时存储，借助于redis的内存特性，主要做一些共享之类的功能。</p>
<p>比如：计数器应用、会话共享、购物车状态数据等</p>
</li>
<li>
<p>Set (集合)</p>
<p>集合主要是数据的统计，由于数据本身具有权重的特性，所以判断数据是否存在的特性要比list好很多。</p>
<p>比如：获得共同数据、安全防御的ip判断、社交好友等</p>
</li>
</ul>
<br>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>以数据存储本身的角度来说场景
		有序集合	- 各种排行、topn
		list 	   - 数据的排布，顺序
		sort集合    - 范围数据列表
		string     - 数据的存储
		hash字典	  - 数据分类(子分类)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>只要你有丰富的想象力，redis你想着么用就怎么用。</p>
<br>
<h2 id="redis-部署" tabindex="-1"><a class="header-anchor" href="#redis-部署" aria-hidden="true">#</a> Redis 部署</h2>
<p><strong>Redis</strong> 的安装有两种方式，一个是多主机环境下使用、一个是单台主机部署方便实验测试。</p>
<p><strong>通过软件源安装</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 安装源仓库</span>
...
info
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>手工安装方式</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 下载软件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>启动命令</strong></p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/Redis启动命令.jpg" alt="Redis启动命令" tabindex="0" loading="lazy"><figcaption>Redis启动命令</figcaption></figure>
<p><strong>前台方式启动 redis</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>redis-server /data/server/redis/etc/redis.conf
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/Redis前台方式启动.jpg" alt="Redis前台方式启动" tabindex="0" loading="lazy"><figcaption>Redis前台方式启动</figcaption></figure>
<p>检查效果</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/Redis启动端口.jpg" alt="Redis启动端口" tabindex="0" loading="lazy"><figcaption>Redis启动端口</figcaption></figure>
<p>redis在可以基于同一个配置文件启动多个程序</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 启动多个实例</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/Redis多实例.jpg" alt="Redis多实例" tabindex="0" loading="lazy"><figcaption>Redis多实例</figcaption></figure>
<p><strong>后台方式启动</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 定制redis配置文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="简单实践" tabindex="-1"><a class="header-anchor" href="#简单实践" aria-hidden="true">#</a> 简单实践</h2>
<h3 id="查看配置" tabindex="-1"><a class="header-anchor" href="#查看配置" aria-hidden="true">#</a> 查看配置</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root@python-auto:/etc/redis<span class="token comment"># grep -Env '#|^$' redis.conf</span>
...
<h3 id="常用操作命令" tabindex="-1"><a class="header-anchor" href="#常用操作命令" aria-hidden="true">#</a> 常用操作命令</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 连接数据库</span>
...
<p>​</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> <span class="token builtin class-name">help</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="命令组解析" tabindex="-1"><a class="header-anchor" href="#命令组解析" aria-hidden="true">#</a> 命令组解析</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>redis将大量的命令进行了简单的分组操作，对于6.2.5来说，他有 <span class="token number">15</span>个命令组
@generic 通用的命令组
@string 字符相关命令组
@list 列表相关命令组
@set 集合相关命令组
...
group: connection
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>简单实践</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 选择数据库</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 获取所有的key信息</span>
...
<p>string类型是实战中应用最多的数据类型，可以用于各种其他类型数据的值的存储，非常方便</p>
...
<p><strong>示例</strong>：
cookie、session、校验码等</p>
<p><strong>简单实践</strong></p>
<h4 id="设定key" tabindex="-1"><a class="header-anchor" href="#设定key" aria-hidden="true">#</a> 设定key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>设定一个普通的key
...
<h4 id="获取key" tabindex="-1"><a class="header-anchor" href="#获取key" aria-hidden="true">#</a> 获取key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>获取一个key
get key
...
<h4 id="删除key" tabindex="-1"><a class="header-anchor" href="#删除key" aria-hidden="true">#</a> 删除key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>删除一个key
del key1
...
<p>list 是一个string类型的 列表，redis的每个list都可以存储 2^32 -1 个元素，列表的元素方便排
序、获取、统计等相关操作。</p>
<p>各种各样的列表场景都可以</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/lish类型数据.jpg" alt="lish类型数据" tabindex="0" loading="lazy"><figcaption>lish类型数据</figcaption></figure>
<h4 id="设定key-1" tabindex="-1"><a class="header-anchor" href="#设定key-1" aria-hidden="true">#</a> <br>设定key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>左侧添加数据
...
<h4 id="获取key-1" tabindex="-1"><a class="header-anchor" href="#获取key-1" aria-hidden="true">#</a> 获取key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>获取列表数据
...
<h4 id="删除key-1" tabindex="-1"><a class="header-anchor" href="#删除key-1" aria-hidden="true">#</a> 删除key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>从key中删除指定的value
...
<p>set 是一个string类型的 集合，redis的每个list都可以存储 2^32 -1 个元素，集合元素无序且不重
复，可以进行各种排序统计场景。</p>
<p>场景：
内容不重复的任何场景都可以</p>
<br>
<p><strong>无序集合</strong></p>
<h4 id="设定key-2" tabindex="-1"><a class="header-anchor" href="#设定key-2" aria-hidden="true">#</a> 设定key</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>添加数据
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>获取set数据
SMEMBERS key
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="删除key-2" tabindex="-1"><a class="header-anchor" href="#删除key-2" aria-hidden="true">#</a> <br>删除key</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>从key中删除指定的member
...
<h3 id="sort-set" tabindex="-1"><a class="header-anchor" href="#sort-set" aria-hidden="true">#</a> Sort set</h3>
<p>set 是一个string类型的 集合，redis的每个list都可以存储 2^32 -1 个元素，集合元素无序且不重
复，可以进行各种排序统计场景。</p>
<p><strong>有序集合 sortset</strong></p>
<p>场景：
排行榜、topN</p>
<h4 id="设定key-3" tabindex="-1"><a class="header-anchor" href="#设定key-3" aria-hidden="true">#</a> 设定key</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>添加数据
...
<h4 id="获取key-2" tabindex="-1"><a class="header-anchor" href="#获取key-2" aria-hidden="true">#</a> 获取key</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>获取有序集合数据
...
<h4 id="删除key-3" tabindex="-1"><a class="header-anchor" href="#删除key-3" aria-hidden="true">#</a> 删除key</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>从key中删除指定的member
ZREM key member [member ...]

从key的随机删除指定个数的 member
ZREMRANGEBYSCORE key min max
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>sortset 实践
...
<p>hash 是一个string类型的 字段和值 的关联表，redis的每个hash都可以存储 2^32 -1 个键值对，非
常适合于存储对象场景。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/hash.jpg" alt="hash" tabindex="0" loading="lazy"><figcaption>hash</figcaption></figure>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>使用场景：
	某个对象的特定属性：
		person: {
			username: zhangsan,
			password: 123456,
...
<h4 id="设定-key" tabindex="-1"><a class="header-anchor" href="#设定-key" aria-hidden="true">#</a> 设定 key</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>添加数据
...
<h4 id="获取-key" tabindex="-1"><a class="header-anchor" href="#获取-key" aria-hidden="true">#</a> <strong>获取 key</strong></h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>获取所有属性
HKEYS key

获取多个属性的值
HMGET key field [field ...]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>
<p><strong>删除 key</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>从key中删除指定的value
HDEL key field [field ...]

直接删除key所有的内容
del key
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>实践：
增加数据
