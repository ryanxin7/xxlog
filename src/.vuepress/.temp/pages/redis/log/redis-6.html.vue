<template><div><h1 id="redis-主从同步" tabindex="-1"><a class="header-anchor" href="#redis-主从同步" aria-hidden="true">#</a> Redis 主从同步</h1>
<p>redis 作为一个分布式的数据缓存平台，我们可以借助于redis的多实例机制，让多个实例间的数据，
达成一个同步的效果，这样即使某个实例出现异常，也不影响数据整体的使用。</p>
<h3 id="基础知识" tabindex="-1"><a class="header-anchor" href="#基础知识" aria-hidden="true">#</a> 基础知识</h3>
<h4 id="复制特性" tabindex="-1"><a class="header-anchor" href="#复制特性" aria-hidden="true">#</a> 复制特性</h4>
<ul>
...
<h4 id="实践要点" tabindex="-1"><a class="header-anchor" href="#实践要点" aria-hidden="true">#</a> 实践要点</h4>
...
<p>谁是我的老大？</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>1 主角色redis 必须开启持久化功能
...
<h4 id="复制命令方式同步" tabindex="-1"><a class="header-anchor" href="#复制命令方式同步" aria-hidden="true">#</a> 复制命令方式同步</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>127.0.0.1:6379> help SLAVEOF
SLAVEOF host port
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>默认情况下，任何一个redis实例启动时候，会自动将自己作为主角色而存在</p>
...
role:master
connected_slaves:0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="同步实践" tabindex="-1"><a class="header-anchor" href="#同步实践" aria-hidden="true">#</a> <strong>同步实践</strong></h5>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>#开启一个redis实例
...
结果显示：
数据同步成功
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="效果验证" tabindex="-1"><a class="header-anchor" href="#效果验证" aria-hidden="true">#</a> 效果验证</h5>
<p>从角色只能查看数据，不能修改数据</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:666<span class="token operator"><span class="token file-descriptor important">6</span>></span> FLUSHALL
...
<h4 id="配置文件方式主从同步" tabindex="-1"><a class="header-anchor" href="#配置文件方式主从同步" aria-hidden="true">#</a> 配置文件方式主从同步</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>简介
对于主从同步来说，
      主角色不用做任何配置
         - 开放自己的怀抱即可
