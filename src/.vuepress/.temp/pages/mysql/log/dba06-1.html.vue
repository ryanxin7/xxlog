<template><div><h1 id="gtid-记录模式管理" tabindex="-1"><a class="header-anchor" href="#gtid-记录模式管理" aria-hidden="true">#</a> GTID 记录模式管理</h1>
<h2 id="_1-gtid-介绍" tabindex="-1"><a class="header-anchor" href="#_1-gtid-介绍" aria-hidden="true">#</a> 1. GTID 介绍</h2>
<ul>
<li>
...
<br>
<h2 id="_2-gtid-组成" tabindex="-1"><a class="header-anchor" href="#_2-gtid-组成" aria-hidden="true">#</a> 2. GTID 组成</h2>
<p>由两部分组成
...
<br>
<h2 id="_3-gtid-幂等性" tabindex="-1"><a class="header-anchor" href="#_3-gtid-幂等性" aria-hidden="true">#</a> 3. GTID 幂等性</h2>
<p>如果拿有GTID的日志去恢复时,检查当前系统中是否有相同GTID号,有相同的就自动跳过</p>
<p>同Ansible剧本跳过同理会影响到binlog恢复和主从复制。</p>
<br>
<br>
<h2 id="_4-gtid-开启和配置" tabindex="-1"><a class="header-anchor" href="#_4-gtid-开启和配置" aria-hidden="true">#</a> 4. GTID 开启和配置</h2>
...
<br>
<br>
<h3 id="_4-1-查看gtid信息" tabindex="-1"><a class="header-anchor" href="#_4-1-查看gtid信息" aria-hidden="true">#</a> 4.1 查看GTID信息</h3>
...
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-DBA/Section6-1-19.png" alt="GTID3" tabindex="0" loading="lazy"><figcaption>GTID3</figcaption></figure>
<br>
...
<br>
<br>
<h3 id="_4-2-基于gtid-恢复数据" tabindex="-1"><a class="header-anchor" href="#_4-2-基于gtid-恢复数据" aria-hidden="true">#</a> 4.2 基于GTID 恢复数据</h3>
<p>开启GTID 后只需截取GTID日志就可以了，GTID是全局事务唯一标号。</p>
<br>
<h4 id="截取日志" tabindex="-1"><a class="header-anchor" href="#截取日志" aria-hidden="true">#</a> 截取日志</h4>
...
<br>
<h4 id="恢复数据" tabindex="-1"><a class="header-anchor" href="#恢复数据" aria-hidden="true">#</a> 恢复数据</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-DBA/Section6-1-21.png" alt="GTID恢复" tabindex="0" loading="lazy"><figcaption>GTID恢复</figcaption></figure>
<br>
<h4 id="报错" tabindex="-1"><a class="header-anchor" href="#报错" aria-hidden="true">#</a> 报错</h4>
