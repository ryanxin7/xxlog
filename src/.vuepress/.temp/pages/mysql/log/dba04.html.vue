...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>公式：表的数据量=平均行长度*行数+索引长度
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>AVG_ROW_LENGTH*TABLE_ROWS+INDEX_LENGTH</code>  统计整个city 表的真实数据量大小</p>
