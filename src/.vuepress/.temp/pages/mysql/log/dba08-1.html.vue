<template><div><h1 id="主从复制高级进阶" tabindex="-1"><a class="header-anchor" href="#主从复制高级进阶" aria-hidden="true">#</a> 主从复制高级进阶</h1>
<h2 id="_1-上节回顾" tabindex="-1"><a class="header-anchor" href="#_1-上节回顾" aria-hidden="true">#</a> 1.上节回顾</h2>
<h3 id="_1-1-binlog-format" tabindex="-1"><a class="header-anchor" href="#_1-1-binlog-format" aria-hidden="true">#</a> 1.1   binlog_format</h3>
<ul>
<li>
...
<br>
<br>
<h3 id="_1-2-主从故障" tabindex="-1"><a class="header-anchor" href="#_1-2-主从故障" aria-hidden="true">#</a> 1.2  主从故障</h3>
<br>
...
<p><strong>SQL 线程</strong></p>
<ul>
<li>回放拿过来的日志</li>
</ul>
<br>
<br>
<h3 id="_1-3-主从延时" tabindex="-1"><a class="header-anchor" href="#_1-3-主从延时" aria-hidden="true">#</a> 1.3  主从延时</h3>
<p>需要在两方面解决由于单进程和串行处理导致的主从延迟问题。</p>
<br>
<p><strong>主库</strong>:</p>
<p><strong>DUMP_T</strong> 线程  默认串行执行</p>
<p>参数：<code v-pre>show variables like 'group_commit%';</code>  允许主库等一段时间一起提交给从库</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-DBA/Section8-2-1.png" alt="从库只读" tabindex="0" loading="lazy"><figcaption>从库只读</figcaption></figure>
<br>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">--使用 gtid </span>
sync_binlog
...
<p><strong>SQL</strong> 线程 :  5.7 GTID MTS  默认只有一个线程进行回放,由于从库是单SQL线程,导致,不管传的日志有多少,只能一次执行一个事务。<br></p>
<p><strong>5.6 版本</strong>,有了GTID,可以实现多SQL线程,但是只能基于不同库的事务进行并发回放.(database)  （不能保证同一库内事务无法保证顺序按一定逻辑顺序执行）。<br></p>
<p><strong>5.7 版本</strong>中,有了增强的GTID,增加了seq_no（通线程下的序列号码）标记,增加了新型的并发SQL线程模式(logical_clock 逻辑时钟),MTS技术   。<br></p>
<p><strong>查看从库的SQL工作线程</strong></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> <span class="token keyword">show</span> variables <span class="token operator">like</span> <span class="token string">'%worker%'</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><br>
<h3 id="_1-4-主从延时的监控" tabindex="-1"><a class="header-anchor" href="#_1-4-主从延时的监控" aria-hidden="true">#</a> 1.4 主从延时的监控</h3>
<br>
<p>主从延迟相关检查参数</p>
<br>
<p><strong>(1) 检查主从有没有的问题?</strong></p>
<p><code v-pre>Seconds_Behind_Master: 0</code></p>
<br>
<p><strong>(2) 有没有主库原因?</strong></p>
<p><code v-pre>Master_Log_File: mysql-bin.000003</code>
<code v-pre>Read_Master_Log_Pos: 154</code></p>
<p><code v-pre>| mysql-bin.000003 |      154</code></p>
<br>
<p><strong>(3) 有没有及时回放</strong></p>
<p><code v-pre>Master_Log_File: mysql-bin.000003</code>
<code v-pre>Read_Master_Log_Pos: 154</code></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">cat</span> relay-log.info 
...
<br>
<h2 id="_2-主从复制高级进阶" tabindex="-1"><a class="header-anchor" href="#_2-主从复制高级进阶" aria-hidden="true">#</a> 2. 主从复制高级进阶</h2>
<h3 id="_2-1-延时从库" tabindex="-1"><a class="header-anchor" href="#_2-1-延时从库" aria-hidden="true">#</a> 2.1 延时从库</h3>
<p><strong>介绍及配置</strong></p>
<br>
<p><strong>主要使 SQL线程延时</strong>:  数据已经写入relaylog中了,SQL线程&quot;慢点&quot;运行
一般企业建议3-6小时,具体看公司运维人员对于故障的反应时间</p>
<br>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span>stop slave<span class="token punctuation">;</span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> <span class="token keyword">show</span> slave <span class="token keyword">status</span> \G
SQL_Delay: <span class="token number">300</span>
SQL_Remaining_Delay: <span class="token boolean">NULL</span> 最近的日志还差多少秒执行
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-延时从库处理逻辑故障" tabindex="-1"><a class="header-anchor" href="#_2-2-延时从库处理逻辑故障" aria-hidden="true">#</a> 2.2  延时从库处理逻辑故障</h3>
<p><strong>延时从库的恢复思路</strong> （用于从延迟从库的回放日志中恢复主库误删数据）</p>
<p>(1) 监控到数据库逻辑故障
(2) 停从库SQL线程,记录已经回放的位置点(截取日志起点)</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>stop slave sql_thread <span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>(3) 截取relaylog</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>终点</strong>:  主库drop之前的位置点</p>
<pre><code>show relaylog events in ''	
进行截取
</code></pre>
<p>(4) 模拟SQL线程回访日志</p>
<p>​	<strong>从库</strong>  source  导入经过截取的回放日志</p>
<p>(5) 恢复业务</p>
<p><strong>情况一</strong>: 就一个库的话</p>
<p>从库替代主库工作</p>
<p><strong>情况二</strong>:
从库导出故障库,还原到主库中.</p>
<br>
<br>
<h4 id="_2-2-1-故障演练" tabindex="-1"><a class="header-anchor" href="#_2-2-1-故障演练" aria-hidden="true">#</a> 2.2.1 故障演练</h4>
<br>
<p><strong>主库</strong> : 模拟误删数据库操作</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">database</span> delay <span class="token keyword">charset</span> utf8mb4<span class="token punctuation">;</span>
...
<p><strong>从库</strong>:</p>
<p>1.停止从库SQL 线程,获取relay的位置点 626</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> stop slave sql_thread<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.找到relay的截取终点</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> <span class="token keyword">show</span> relaylog events <span class="token operator">in</span> <span class="token string">'db01-relay-bin.000002'</span><span class="token punctuation">;</span>
...
<p>3.截取relay</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">cd</span> /data/3308/data/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4.恢复relay到从库</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从库恢复逻辑损坏比直接在主库用备份恢复要快</p>
<br>
<br>
<h3 id="_2-3-过滤复制" tabindex="-1"><a class="header-anchor" href="#_2-3-过滤复制" aria-hidden="true">#</a> 2.3 过滤复制</h3>
<p>快速恢复测试环境</p>
<p><strong>从库</strong> :</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql <span class="token operator">-</span>S <span class="token operator">/</span><span class="token keyword">data</span><span class="token operator">/</span><span class="token number">3308</span><span class="token operator">/</span>mysql<span class="token punctuation">.</span>sock
<span class="token keyword">drop</span> <span class="token keyword">database</span> delay <span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>主库</strong>:</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mysql <span class="token parameter variable">-S</span> /data/33078/mysql.sock
reset master<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>从库</strong>:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>CHANGE MASTER <span class="token keyword">TO</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>从库</strong>:</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> <span class="token keyword">show</span> slave <span class="token keyword">status</span> \G
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>例子</strong>: 只复制REPL库</p>
...
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-DBA/Section8-2-2.png" alt="从库过滤复制" tabindex="0" loading="lazy"><figcaption>从库过滤复制</figcaption></figure>
<br>
<h3 id="_2-4-gtid-复制" tabindex="-1"><a class="header-anchor" href="#_2-4-gtid-复制" aria-hidden="true">#</a> 2.4  GTID 复制</h3>
<p><strong>应用介绍</strong></p>
<p><strong>GTID</strong> (Global Transaction ID)是对于一个已提交事务的唯一编号，并且是一个全局(主从复制)唯一的编号。</p>
<p><strong>它的官方定义如下</strong>：<br></p>
<p><code v-pre>GTID = source_id</code> ：<code v-pre>transaction_id</code>
<code v-pre>7E11FA47-31CA-19E1-9E56-C43AA21293967:29</code></p>
<br>
**什么是sever_uuid，和Server-id 区别**？
<p><strong>核心特性</strong>: 全局唯一,具备幂等性</p>
<br>
<br>
<p><strong>GTID 核心参数</strong></p>
<p>重要参数：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>gtid<span class="token operator">-</span><span class="token keyword">mode</span><span class="token operator">=</span><span class="token keyword">on</span>                                <span class="token comment">--启用gtid类型，否则就是普通的复制架构</span>
...
<h3 id="_2-5-gtid复制配置过程" tabindex="-1"><a class="header-anchor" href="#_2-5-gtid复制配置过程" aria-hidden="true">#</a> 2.5 GTID复制配置过程</h3>
<br>
<p>(1) 清理环境</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>pkill mysqld
...
EOF</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>prompt=db01 [\\d]&gt;</code> <strong>作用</strong>：定制连接进去的窗口连接会话名字  <code v-pre>\\d</code>显示当前库</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-DBA/Section8-2-3.png" alt="扩展mysql界面" tabindex="0" loading="lazy"><figcaption>扩展mysql界面</figcaption></figure>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>slave1(db02)：
cat > /etc/my.cnf &lt;&lt;EOF
[mysqld]
basedir=/application/mysql
datadir=/data/mysql/data
...
prompt=db02 [\\d]>
EOF
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>\d:</code> 当前数据库连接客户端时通过参数指定。</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>slave2<span class="token punctuation">(</span>db03<span class="token punctuation">)</span>：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>(4) 启动数据库</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>/etc/init.d/mysqld start
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>(5) 构建主从：<br></p>
<p>IP地址 主机名：</p>
<ul>
<li>master:51
slave:52,53</li>
</ul>
<p><strong>51主</strong>:</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">grant</span> <span class="token keyword">replication</span> slave  <span class="token keyword">on</span> <span class="token operator">*</span><span class="token punctuation">.</span><span class="token operator">*</span> <span class="token keyword">to</span> repl<span class="token variable">@'10.0.0.%'</span> identified <span class="token keyword">by</span> <span class="token string">'123'</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>52\53</strong>: <strong>从库</strong></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>change master <span class="token keyword">to</span> 
master_host<span class="token operator">=</span><span class="token string">'10.0.0.51'</span><span class="token punctuation">,</span>
master_user<span class="token operator">=</span><span class="token string">'repl'</span><span class="token punctuation">,</span>
master_password<span class="token operator">=</span><span class="token string">'123'</span> <span class="token punctuation">,</span>
...
<h3 id="_2-6-gtid-复制和普通复制的区别" tabindex="-1"><a class="header-anchor" href="#_2-6-gtid-复制和普通复制的区别" aria-hidden="true">#</a> 2.6 GTID 复制和普通复制的区别</h3>
<p>（0）在主从复制环境中，主库发生过的事务，在全局都是由唯一GTID记录的，更方便Failover<br>
（1）额外功能参数（3个）<br>
...
（4） mysqldump备份时，默认会将备份中包含的事务操作，以下方式:<br></p>
<p><code v-pre>SET @@GLOBAL.GTID_PURGED='8c49d7ec-7e78-11e8-9638-000c29ca725d:1-11';</code></p>
<p>告诉从库，我的备份中已经有以上事务，你就不用运行了，直接从下一个GTID开始请求binlog就行。<br></p>
<br>
<p><strong><code v-pre>mysqldump --set-gitd-purged=off</code> 这个参数加了就构建不了主从</strong></p>
<br>
<br>
<h2 id="_3-半同步" tabindex="-1"><a class="header-anchor" href="#_3-半同步" aria-hidden="true">#</a> 3.半同步</h2>
<p>主库做完的从库不一定做，从库宕机<br></p>
<p>用于解决主从复制数据一致性问题.<br></p>
<p>主库的 ACK_reciver 线程专门在应用层面增加反馈机制.<br></p>
<p>从库relay log 落地写入磁盘会发送ACK确认 ,IO线程会返回一个ACK,主库事务才能提交.<br></p>
<p>如果一直ACK没收到,超过10秒钟会切换为异步复制.   放弃事务。<br></p>
</div></template>
