<template><div><p><strong>当用户访问一个网站时，都发生了事情？</strong></p>
...
<br>
<h2 id="_1-dns迭代查询" tabindex="-1"><a class="header-anchor" href="#_1-dns迭代查询" aria-hidden="true">#</a> 1. DNS迭代查询</h2>
...
<br>
<h2 id="_2-http通讯原理说明" tabindex="-1"><a class="header-anchor" href="#_2-http通讯原理说明" aria-hidden="true">#</a> 2. HTTP通讯原理说明</h2>
<p>① 客户端与服务端建立连接
② 利用已知的IP地址，进行网络三次握手连接建立
③ 本地主机客户端向网站服务端，发出请求 http请求数据包（http请求报文）
④ 网站服务端向本地主机客户端，回复响应 http响应数据包（http响应报文）
⑤ 完成网络四次挥手断开过程</p>
<h2 id="_3-http协议的数据包" tabindex="-1"><a class="header-anchor" href="#_3-http协议的数据包" aria-hidden="true">#</a> 3.HTTP协议的数据包</h2>
<p>HTTP请求报文</p>
<p><strong>1. 请求行</strong></p>
<p>①请求方法: 	Get		--读/看	---获取/拿过来  post	-- 写/提交
...
<br>
<h3 id="_3-2-http响应报文" tabindex="-1"><a class="header-anchor" href="#_3-2-http响应报文" aria-hidden="true">#</a> 3.2 HTTP响应报文</h3>
<br>
<ol>
...
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linuxlinux05-1.png" alt="linux05-1" tabindex="0" loading="lazy"><figcaption>linux05-1</figcaption></figure>
<br>
<h2 id="_4-常见的状态码" tabindex="-1"><a class="header-anchor" href="#_4-常见的状态码" aria-hidden="true">#</a> 4.常见的状态码</h2>
<br>
<table>
<thead>
<tr>
...
<br>
<h2 id="_5-http协议资源信息" tabindex="-1"><a class="header-anchor" href="#_5-http协议资源信息" aria-hidden="true">#</a> 5. HTTP协议资源信息</h2>
<br>
...
<p>URI : <RouterLink to="/ansible/latest/user_guide/playbooks_reuse_roles.html">/ansible/latest/user_guide/playbooks_reuse_roles.html</RouterLink></p>
<p>​      <br></p>
<br>
<h3 id="_5-1-网站页面静态资源" tabindex="-1"><a class="header-anchor" href="#_5-1-网站页面静态资源" aria-hidden="true">#</a> 5.1 网站页面静态资源</h3>
<br>
<div class="hint-container tip">
<p class="hint-container-title">特点说明</p>
<p>要什么给我什么,  <code v-pre>xin.jpg  index.html</code> 标准文件后缀</p>
<ul>
<li>
...
<br>
<h3 id="_5-2-网站页面动态资源" tabindex="-1"><a class="header-anchor" href="#_5-2-网站页面动态资源" aria-hidden="true">#</a> 5.2 网站页面动态资源</h3>
<br>
<div class="hint-container tip">
<p class="hint-container-title">特点说明</p>
...
<li>
<p>动态资源页面会出现 &quot;<code v-pre>?</code>&quot; &quot;<code v-pre>&amp;</code>&quot;, 不便于被搜索引擎收录</p>
</li>
<li>
...
<br>
<h3 id="_5-3-伪静态资源" tabindex="-1"><a class="header-anchor" href="#_5-3-伪静态资源" aria-hidden="true">#</a> 5.3 伪静态资源</h3>
 <br>
