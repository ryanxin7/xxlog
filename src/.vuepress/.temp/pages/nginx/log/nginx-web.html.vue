<template><div><h1 id="nginx-web快速入门" tabindex="-1"><a class="header-anchor" href="#nginx-web快速入门" aria-hidden="true">#</a> Nginx Web快速入门</h1>
<h2 id="_1-nginx-介绍" tabindex="-1"><a class="header-anchor" href="#_1-nginx-介绍" aria-hidden="true">#</a> 1.Nginx 介绍</h2>
<h3 id="_1-1什么是nginx" tabindex="-1"><a class="header-anchor" href="#_1-1什么是nginx" aria-hidden="true">#</a> 1.1什么是Nginx ？</h3>
...
<br>
<br>
<h3 id="_1-2为什么选择-nginx" tabindex="-1"><a class="header-anchor" href="#_1-2为什么选择-nginx" aria-hidden="true">#</a> 1.2为什么选择 Nginx ？</h3>
<h4 id="_1-2-1高性能、高并发" tabindex="-1"><a class="header-anchor" href="#_1-2-1高性能、高并发" aria-hidden="true">#</a> 1.2.1高性能、高并发</h4>
<p>通常正常情况下，单次请求会得到更快的响应。另一方面在高峰期(如有数以万计的并发请求)，Nginx可以比其他Web服务器更快地响应请求。</p>
<br>
<h4 id="_1-2-2高扩展性" tabindex="-1"><a class="header-anchor" href="#_1-2-2高扩展性" aria-hidden="true">#</a> 1.2.2高扩展性</h4>
<p>Nginx功能模块化。Nginx官方提供了非常多的优秀模块提供使用。这些模块都可以实现快速增加和减少。</p>
<br>
<h4 id="_1-2-3高可靠性" tabindex="-1"><a class="header-anchor" href="#_1-2-3高可靠性" aria-hidden="true">#</a> 1.2.3高可靠性</h4>
<p>所谓高可靠性，是指Nginx可以在服务器上持续不间断的运行，而很多web服务器往往运行几周或几个月就需要进行一次重启。对于nginx这样的一一个高并发、高性能的反向代理服务器而言，他往往运行网站架构的最前端，那么此时如果我们企业如果想提供9999、99999,对于nginx持续运行能够宕机的时间，一年可能只能以秒来计算，所以在这样的一个角色中，nginx的高可靠性为我们提供了非常好的保证。</p>
<br>
<h4 id="_1-2-4-热部署" tabindex="-1"><a class="header-anchor" href="#_1-2-4-热部署" aria-hidden="true">#</a> 1.2.4 热部署</h4>
<p><code v-pre>热部署</code>:是指在不停服务的情况下升级nginx,这个功能非常的重要。对于普通的服务，需要kill掉进程在启动，但对于Nginx而言，如果Nginx有 很多的客户端连接，那么kil掉Nginx。 Nginx会像客户端发送tcp reset复位包，但很多客户端无法很好的理解reset包，就会造成异常。由于Nginx的master管理进程与worker工作进程的分离设计，使得Nginx能够在7x24小时不间断服务的前提下，升级Nginx的可执行文件。当然，也支持不停止服务更新配置、更换日志文件等功能。</p>
<br>
<h4 id="_1-2-5-应用广泛" tabindex="-1"><a class="header-anchor" href="#_1-2-5-应用广泛" aria-hidden="true">#</a> 1.2.5 应用广泛</h4>
<p>首先Nginx技术成熟，具备企业最常使用的功能，如代理、代理缓存、负载均衡、静态资源、动静分离、Https、 Inmp、 nmt等等其次使用Nginx统一技术栈，降低维护成本，同时降低技术更新成本。</p>
<br>
<h4 id="_1-2-6-网络模型" tabindex="-1"><a class="header-anchor" href="#_1-2-6-网络模型" aria-hidden="true">#</a> 1.2.6 网络模型</h4>
<p>Nginx使用<code v-pre>Epool</code>网络模型，而常听到Apache 采用的是<code v-pre>Select</code>网络模型。</p>
<ul>
<li>Select:当用户发起一次请求，select模型就 会进行一次遍历扫描，从而导致性能低下。</li>
<li>Epoll:当用户发起请求，epoll模型会直接进行处理，效率高效。</li>
</ul>
<br>
<h3 id="_1-3-nginx应用场景" tabindex="-1"><a class="header-anchor" href="#_1-3-nginx应用场景" aria-hidden="true">#</a> 1.3 Nginx应用场景</h3>
<p>Nginx的主要使用场景我归纳为三个，分为是静态资源服务、代理资源服务、安全服务，场景详细介绍如下：
如下图是一个网站的基本架构， 首先用户请求先到达nginx,然后在到tomcat或php这样的应用
服务器，然后应用服务器在去访问redis、mysq|l这样的数据库，提供基本的数据功能。
<br></p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx基本结构.jpg" alt="nginx基本结构" tabindex="0" loading="lazy"><figcaption>nginx基本结构</figcaption></figure>
<br>
<h4 id="_1-3-1-nginx-负载均衡" tabindex="-1"><a class="header-anchor" href="#_1-3-1-nginx-负载均衡" aria-hidden="true">#</a> 1.3.1 nginx 负载均衡</h4>
<p>那么这里有一个问题，我们的程序代码要求开发效率高,所以他的运行效率是很低的，或者说它并发是受限，所以我们需要很多应用服务组成一个集群，为更多用户提供访问。而应用服务一但构成集群， 则需要我们的nginx 具有反向代理功能，这样可以将动态请求传倒给集群服务。</p>
<br>
<p>但很多应用构成集群，那么一定会带来两个需求。</p>
<ol>
<li>应用服务器需要动态扩展。</li>
<li>有些服务出问题需要做容灾。
那么我们的反向代理必须具备负载均衡功能。</li>
</ol>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx负载均衡.jpg" alt="nginx负载均衡" tabindex="0" loading="lazy"><figcaption>nginx负载均衡</figcaption></figure>
<br>
<br>
<h4 id="_1-3-2-nginx-代理缓存" tabindex="-1"><a class="header-anchor" href="#_1-3-2-nginx-代理缓存" aria-hidden="true">#</a> 1.3.2 nginx 代理缓存</h4>
<p>其次，随着我们网络链路的增长，用户体验到的时延则会增加。如果我们能把一段时间内不会发生变化的&quot;动态&quot;内容，缓存在Nginx,由Nginx 直接向用户提供访问，那么这样用户请求的时延就会减少很多，所以在这里反向代理会演生出另外一个功能&quot;缓存&quot;，因为它能加速我们的访问。</p>
<br>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx代理缓存.jpg" alt="nginx代理缓存" tabindex="0" loading="lazy"><figcaption>nginx代理缓存</figcaption></figure>
<br>
<h4 id="_1-3-3-nginx-静态服务" tabindex="-1"><a class="header-anchor" href="#_1-3-3-nginx-静态服务" aria-hidden="true">#</a> 1.3.3 nginx 静态服务</h4>
<p>在很多时候我们访问docs、pdf、mp4、 png等这样的<code v-pre>静态资源</code>时，是没有必要将这些请求通过Nginx交给后端的应用服务，我们只需要通过Nginx直接处理'<code v-pre>静态资源</code>&quot;即可。这是Nginx的静态资源功能。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx静态服务.jpg" alt="nginx静态服务" tabindex="0" loading="lazy"><figcaption>nginx静态服务</figcaption></figure>
<br>
<h4 id="_1-3-4-nginx-安全服务" tabindex="-1"><a class="header-anchor" href="#_1-3-4-nginx-安全服务" aria-hidden="true">#</a> 1.3.4 nginx 安全服务</h4>
<p>当我们使用http网站时，可能会遭到劫持和篡改, 如果使用https安全通讯协议，那么数据在传输过程中是加密的，从而能有效的避免黑客窃取或者篡改数据信息，同时也能避免网站在传输过程中的信息泄露。大大的提升我们网站安全。</p>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx安全服务.jpg" alt="nginx安全服务" tabindex="0" loading="lazy"><figcaption>nginx安全服务</figcaption></figure>
<br>
<br>
<h3 id="_1-4-nginx组成部分" tabindex="-1"><a class="header-anchor" href="#_1-4-nginx组成部分" aria-hidden="true">#</a> 1.4 Nginx组成部分</h3>
<p>在这里我们将Nginx的组成架构比喻为-辆汽车:<br></p>
<p>这个<code v-pre>汽车</code>提供了基本的驾驶功能，但是还需要一个<code v-pre>驾驶员</code>控制这辆汽车开往哪个方向,同时该汽车行驶过的地方还会形成<code v-pre>GPS轨迹</code>，如果汽车在行驶的过程中出现了任何问题，我们需要一个<code v-pre>黑匣子</code>，分析是汽车本身的问题，还是驾驶人员的操作出现了问题。</p>
<br>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/nginx服务组成.jpg" alt="nginx服务组成" tabindex="0" loading="lazy"><figcaption>nginx服务组成</figcaption></figure>
<br>
<ol>
<li>
<p>第一个组成部分<code v-pre>Nginx二进制可执行文件</code>:它是Nginx本身框架以及相关模块等构建的一个二进制文件，这个文件就相当于汽车本身，所有的功能都由它提供。</p>
</li>
<li>
<p>第二个组成部分<code v-pre>Nginx.conf</code>文件:它相当于驾驶人员，虽然二进制可执行文件已经提供了许多的功能，但是这些功能究竟有没有开启，或者开启后定义怎样的行为去处理请求，都是由<code v-pre>nginx.conf</code>这个文件决定的，所以他就相当于这个汽车的驾驶员，控制这个汽车的行为。</p>
</li>
<li>
<p>第三个组成部分<code v-pre>access.log</code>:它相当于这辆汽车经过所有地方形成的GPS轨迹，<code v-pre>access.log</code>会记录Nginx处理过的每一条HTTP的请求信息 响应信息。</p>
</li>
<li>
<p>第四个组成部分<code v-pre>error.log</code>:它相当于黑匣子，当出现了- -些不可预期的问题时，可以通过error.log将问题定位出来。</p>
</li>
</ol>
<br>
<br>
<h3 id="_1-5-nginx组成部分小结" tabindex="-1"><a class="header-anchor" href="#_1-5-nginx组成部分小结" aria-hidden="true">#</a> 1.5 Nginx组成部分小结:</h3>
<p>Nginx的组成部分是相辅相成，Nginx二进制可执行文件和Nginx.conf文件，它定义了Nginx处理请求的方式。
而如果我们想对nginx服务做一些web的运 营和运维，需要对access.log做进一步分析。而如果出现了任何未知的错误，或者预期的行为不-致时，应该通过error.log 去定位根本性的问
题。</p>
<br>
<br>
<h2 id="_2-nginx快速安装" tabindex="-1"><a class="header-anchor" href="#_2-nginx快速安装" aria-hidden="true">#</a> 2.Nginx快速安装</h2>
<p>安装Nginx软件的方式有很多种，分为如下几种：</p>
<ol>
<li>源码编译👉Nginx (1.版本随意2.安装复杂3.升级繁琐)</li>
<li>epel仓库👉&gt;Nginx (1.版本较低2.安装简单3.配置不易读)</li>
<li>官方仓库👉Nginx (1.版本较新2.安装简单3.配置易读，推荐😊)</li>
</ol>
<br>
<br>
<h3 id="_2-1-安装nginx软件所需依赖包" tabindex="-1"><a class="header-anchor" href="#_2-1-安装nginx软件所需依赖包" aria-hidden="true">#</a> 2.1 安装Nginx软件所需依赖包</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web ~<span class="token punctuation">]</span><span class="token comment"># yum install -y gcc gcc-c++ autoconf pcre pcre-devel make automake httpd-tools</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><br>
<h3 id="_2-2-配置nginx官方yum源" tabindex="-1"><a class="header-anchor" href="#_2-2-配置nginx官方yum源" aria-hidden="true">#</a> 2.2 配置nginx官方yum源</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>nginx-stable<span class="token punctuation">]</span>
...
<h3 id="_2-3-安装nginx服务-启动并加入开机自启" tabindex="-1"><a class="header-anchor" href="#_2-3-安装nginx服务-启动并加入开机自启" aria-hidden="true">#</a> 2.3 安装Nginx服务,启动并加入开机自启</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web ~<span class="token punctuation">]</span><span class="token comment"># yum install nginx -y</span>
...
<br>
<h3 id="_2-4-通过浏览器访问该服务器ip地址获取资源" tabindex="-1"><a class="header-anchor" href="#_2-4-通过浏览器访问该服务器ip地址获取资源" aria-hidden="true">#</a> 2.4 通过浏览器访问该服务器ip地址获取资源</h3>
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/welcomnginx.jpg" alt="welcomnginx" tabindex="0" loading="lazy"><figcaption>welcomnginx</figcaption></figure>
<br>
<h3 id="_2-5-检查nginx软件版本以及编译参数" tabindex="-1"><a class="header-anchor" href="#_2-5-检查nginx软件版本以及编译参数" aria-hidden="true">#</a> 2.5 检查Nginx软件版本以及编译参数</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web ~<span class="token punctuation">]</span><span class="token comment"># nginx -V</span>
nginx version: nginx/1.16.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><br>
<br>
<h3 id="_2-6-nginx软件目录结构" tabindex="-1"><a class="header-anchor" href="#_2-6-nginx软件目录结构" aria-hidden="true">#</a> 2.6 Nginx软件目录结构</h3>
<p>为了让大家更清晰的了解Nginx软件的全貌，可使用<code v-pre>rpm -ql nginx</code>查看整体的目录结构及对应的功能，如下表格整理了Nginx比较重要的配置文件.</p>
<br>
<h4 id="_2-6-1-nginx主配置文件" tabindex="-1"><a class="header-anchor" href="#_2-6-1-nginx主配置文件" aria-hidden="true">#</a> 2.6.1 Nginx主配置文件</h4>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/nginx.conf</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">nginx主配置文件</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/conf.d/default.conf</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">默认网站配置文件</td>
</tr>
</tbody>
</table>
<br>
<h4 id="_2-6-2-nginx代理相关参数文件" tabindex="-1"><a class="header-anchor" href="#_2-6-2-nginx代理相关参数文件" aria-hidden="true">#</a> 2.6.2 Nginx代理相关参数文件</h4>
<table>
<thead>
<tr>
<th style="text-align:center">路径</th>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/fastcgi_ params</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">Fastcgi代理配置文件</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/scgi params</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">scgi代理配置文件</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/uwsgi_ params</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">uwsgi代理配置文件</td>
</tr>
</tbody>
</table>
<br>
<h4 id="_2-6-3-nginx编码相关配置文件" tabindex="-1"><a class="header-anchor" href="#_2-6-3-nginx编码相关配置文件" aria-hidden="true">#</a> 2.6.3 Nginx编码相关配置文件</h4>
<table>
<thead>
<tr>
<th style="text-align:center">路径</th>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/win-utf</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">Nginx编码转换映射文件</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/koi-utf</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">Nginx编码转换映射文件</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/koi-win</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">Nginx编码转换映射文件</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/nginx/mime.types</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">Content-Type与扩展名</td>
</tr>
</tbody>
</table>
<br>
<h4 id="_2-6-4-nginx管理相关命令" tabindex="-1"><a class="header-anchor" href="#_2-6-4-nginx管理相关命令" aria-hidden="true">#</a> 2.6.4 Nginx管理相关命令</h4>
<table>
<thead>
<tr>
<th style="text-align:center">路径</th>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>/usr/sbin/nginx</code></td>
<td style="text-align:center">命令</td>
<td style="text-align:center">Nginx命令行管理终端工具</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/usr/sbin/nginx-debug</code></td>
<td style="text-align:center">命令</td>
<td style="text-align:center">Nginx命令行与终端调试工具</td>
</tr>
</tbody>
</table>
<br>
<h4 id="_2-6-5-nginx日志相关目录与文件" tabindex="-1"><a class="header-anchor" href="#_2-6-5-nginx日志相关目录与文件" aria-hidden="true">#</a> 2.6.5 Nginx日志相关目录与文件</h4>
<table>
<thead>
<tr>
<th style="text-align:center">路径</th>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>/var/log/nginx</code></td>
<td style="text-align:center">目录</td>
<td style="text-align:center">Nginx默认存放日志目录</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/etc/logrotate.d/nginx</code></td>
<td style="text-align:center">配置文件</td>
<td style="text-align:center">Nginx默认的日志切割</td>
</tr>
<tr>
...
<h2 id="_3-nginx基本配置" tabindex="-1"><a class="header-anchor" href="#_3-nginx基本配置" aria-hidden="true">#</a> 3.Nginx基本配置</h2>
<p>Nginx主配置文件<code v-pre>/etc/nginx/nginx.conf</code>是一个纯文本类型的文件， 整个配置文件是以区块的形式组织的。
一般，每个区块以一 对大括号<code v-pre>{}</code>来表示开始与结束。</p>
<p>Nginx主配置文件整体分为三块进行学习，分别是CoreModule(核心模块)， EventModule(事件驱动模块)，HttpCoreModule(http内核模块)</p>
<br>
<p><code v-pre>CoreModule</code>核心模块</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>user www<span class="token punctuation">;</span>                        <span class="token comment">#Nginx进程所使用的用户</span>
...
<p><code v-pre>events</code>事件模块</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>events <span class="token punctuation">{</span>
...
<br>
<p><code v-pre>http</code>内核模块</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>http <span class="token punctuation">{</span> <span class="token comment">#http层开始</span>
<span class="token punctuation">..</span>.
...
<p><strong>PS</strong>: Nginx中的<code v-pre>http</code>、<code v-pre>server</code>、<code v-pre>location</code> 之间的关系是?<br>
<code v-pre>http标签</code> 主要用来解决用户的请求与响应。<br>
<code v-pre>server标签</code>主要用来响应具体的某一个网站。<br>
<code v-pre>location标签 </code>主要用于匹配网站具体URL路径。<br>
<code v-pre>http{}</code> 层下允许有多个 <code v-pre>Server{}</code>,一个<code v-pre>Server{}</code> 下又允许有多<code v-pre>locationf{}</code><br></p>
<br>
<h2 id="_4-nginx搭建网站" tabindex="-1"><a class="header-anchor" href="#_4-nginx搭建网站" aria-hidden="true">#</a> 4.Nginx搭建网站</h2>
<h3 id="_4-1-新增nginx配置文件" tabindex="-1"><a class="header-anchor" href="#_4-1-新增nginx配置文件" aria-hidden="true">#</a> 4.1 新增nginx配置文件</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-放置游戏源代码文件至nginx配置文件root指定的目录" tabindex="-1"><a class="header-anchor" href="#_4-2-放置游戏源代码文件至nginx配置文件root指定的目录" aria-hidden="true">#</a> 4.2 放置游戏源代码文件至nginx配置文件root指定的目录</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web01 conf.d<span class="token punctuation">]</span><span class="token comment"># mkdir /code &amp;&amp; cd /code</span>
...
<h3 id="_4-3-检查nginx的语法是否存在错误" tabindex="-1"><a class="header-anchor" href="#_4-3-检查nginx的语法是否存在错误" aria-hidden="true">#</a> 4.3 检查nginx的语法是否存在错误</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web01 code<span class="token punctuation">]</span><span class="token comment"># nginx -t</span>
...
<h3 id="_4-4-重载nginx-服务" tabindex="-1"><a class="header-anchor" href="#_4-4-重载nginx-服务" aria-hidden="true">#</a> 4.4 重载Nginx 服务</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web01 code<span class="token punctuation">]</span><span class="token comment"># systemctl reload nginx</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><br>
<h2 id="_5-nginx-虚拟主机" tabindex="-1"><a class="header-anchor" href="#_5-nginx-虚拟主机" aria-hidden="true">#</a> 5.Nginx 虚拟主机</h2>
<p><strong>Nginx 配置虚拟主机有如下三种方式</strong>:</p>
<ol>
<li>基于主机多P方式</li>
<li>基于端口的配置方式</li>
<li>基于多个hosts名称方式(多域名方式)</li>
</ol>
<br>
<h3 id="_5-1-nginx-基于多网卡多ip方式配置实践" tabindex="-1"><a class="header-anchor" href="#_5-1-nginx-基于多网卡多ip方式配置实践" aria-hidden="true">#</a> 5.1 Nginx 基于多网卡多IP方式配置实践</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
    <span class="token punctuation">..</span>.
...
<h3 id="_5-2-nginx-基于端口虚拟主机配置实践" tabindex="-1"><a class="header-anchor" href="#_5-2-nginx-基于端口虚拟主机配置实践" aria-hidden="true">#</a> 5.2 Nginx 基于端口虚拟主机配置实践</h3>
<p>Nginx多端口虚拟主机方式，具体配置如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#仅修改listen.监听端口即可，但不能和系统端口出现冲突</span>
server <span class="token punctuation">{</span>
    <span class="token punctuation">..</span>.
listen <span class="token number">80</span><span class="token punctuation">;</span>
    <span class="token punctuation">..</span>.
...
<h3 id="_5-2-nginx-基于host名称虚拟主机配置实践" tabindex="-1"><a class="header-anchor" href="#_5-2-nginx-基于host名称虚拟主机配置实践" aria-hidden="true">#</a> 5.2 Nginx 基于Host名称虚拟主机配置实践</h3>
<p>1.创建对应的web站点目录以及程序代码</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web01 ~<span class="token punctuation">]</span><span class="token comment"># mkdir /code/{server1, server2}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.配置不同域名的虚拟主机</p>
...
<br>
<h2 id="_6-nginx常用模块" tabindex="-1"><a class="header-anchor" href="#_6-nginx常用模块" aria-hidden="true">#</a> 6.Nginx常用模块</h2>
<h3 id="_6-1-nginx目录索引" tabindex="-1"><a class="header-anchor" href="#_6-1-nginx目录索引" aria-hidden="true">#</a> 6.1 Nginx目录索引</h3>
<p>当<code v-pre>ngx_http_jindex_module</code>模块找不到索引文件时，通常会将请求传递给<code v-pre>ngx_ http_autoindex_module</code>模块。<br>
<code v-pre>ngx_ http_autoindex_module</code>模块处理以斜杠字符(/)结尾的请求，并生成目录列表。<br></p>
<br>
<h4 id="_6-1-1-指令" tabindex="-1"><a class="header-anchor" href="#_6-1-1-指令" aria-hidden="true">#</a> 6.1.1 指令</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#启用或禁用目录列表输出，on开启， off关闭。</span>
...
<h4 id="_6-1-2-场景示例-目录索引" tabindex="-1"><a class="header-anchor" href="#_6-1-2-场景示例-目录索引" aria-hidden="true">#</a> 6.1.2 场景示例:目录索引</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@web ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/conf.d/mirror.jx.com.conf</span>
server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
...
<h4 id="_6-1-3-场景示例-模拟搭建企业内部yum仓库" tabindex="-1"><a class="header-anchor" href="#_6-1-3-场景示例-模拟搭建企业内部yum仓库" aria-hidden="true">#</a> 6.1.3 场景示例:模拟搭建企业内部yum仓库</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
    server_name mirror.jx.com<span class="token punctuation">;</span>
    charset utf-8<span class="token punctuation">;</span>
...
<br>
<h3 id="_6-2-nginx访问控制" tabindex="-1"><a class="header-anchor" href="#_6-2-nginx访问控制" aria-hidden="true">#</a> 6.2 Nginx访问控制</h3>
<p><code v-pre>ngx_http_access_module</code>模块允许限制对某些客户端地址的访问。</p>
<h3 id="_6-2-1-指令" tabindex="-1"><a class="header-anchor" href="#_6-2-1-指令" aria-hidden="true">#</a> 6.2.1 指令</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>
...
<h4 id="_6-2-3-场景示例-拒绝指定的ip访问该网站的-centos-其他ip全部允许访问。" tabindex="-1"><a class="header-anchor" href="#_6-2-3-场景示例-拒绝指定的ip访问该网站的-centos-其他ip全部允许访问。" aria-hidden="true">#</a> 6.2.3 场景示例，拒绝指定的IP访问该网站的/centos,其他IP全部允许访问。</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
    server_ name mirror.jx.com<span class="token punctuation">;</span>
    charset utf-8<span class="token punctuation">;</span>
...
<h4 id="_6-2-4-指令" tabindex="-1"><a class="header-anchor" href="#_6-2-4-指令" aria-hidden="true">#</a> 6.2.4 指令</h4>
...
<h4 id="_6-2-5-场景示例-基于用户名和密码认证实践。" tabindex="-1"><a class="header-anchor" href="#_6-2-5-场景示例-基于用户名和密码认证实践。" aria-hidden="true">#</a> 6.2.5 场景示例，基于用户名和密码认证实践。</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>
server <span class="token punctuation">{</span>
     listen <span class="token number">80</span><span class="token punctuation">;</span>
     server_name mirror.jx.com<span class="token punctuation">;</span>
...
<br>
<h3 id="_6-3-nginx请求限制与链接限制" tabindex="-1"><a class="header-anchor" href="#_6-3-nginx请求限制与链接限制" aria-hidden="true">#</a> 6.3 Nginx请求限制与链接限制</h3>
<h4 id="_6-3-1-为什么要做限制" tabindex="-1"><a class="header-anchor" href="#_6-3-1-为什么要做限制" aria-hidden="true">#</a> 6.3.1 为什么要做限制?</h4>
<p>限制某个用户在一定时间内能够产生的Http请求。或者说限制某个用户的下载速度。
<br></p>
<br>
<h4 id="_6-3-2-应用场景" tabindex="-1"><a class="header-anchor" href="#_6-3-2-应用场景" aria-hidden="true">#</a> 6.3.2 应用场景</h4>
<ul>
...
<br>
<h4 id="_6-3-3-请求频率限速实现的原理" tabindex="-1"><a class="header-anchor" href="#_6-3-3-请求频率限速实现的原理" aria-hidden="true">#</a> 6.3.3 请求频率限速实现的原理?</h4>
...
<br>
<h4 id="_6-3-4-场景实践-限制单位时间内所产生的http请求数。" tabindex="-1"><a class="header-anchor" href="#_6-3-4-场景实践-限制单位时间内所产生的http请求数。" aria-hidden="true">#</a> 6.3.4 场景实践 限制单位时间内所产生的Http请求数。</h4>
<ol>
<li>模块指令：</li>
</ol>
...
<br>
<p>Nginx 默认包含了 <code v-pre>http_limit_conn_module</code> 模块，能够帮助我们对网站的用户请求量，网速，IP 等进行限制。防止不法分子而已对我们的网站进行攻击。<br></p>
...
<h4 id="_6-3-5-场景实践-限制客户端同一时刻的并发连接数。" tabindex="-1"><a class="header-anchor" href="#_6-3-5-场景实践-限制客户端同一时刻的并发连接数。" aria-hidden="true">#</a> 6.3.5 场景实践 限制客户端同一时刻的并发连接数。</h4>
<ol>
<li>模块指令</li>
</ol>
...
<br>
<h4 id="_6-3-6-场景实践三-限制下载速度。" tabindex="-1"><a class="header-anchor" href="#_6-3-6-场景实践三-限制下载速度。" aria-hidden="true">#</a> 6.3.6 场景实践三 限制下载速度。</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>server <span class="token punctuation">{</span>
listen <span class="token number">80</span><span class="token punctuation">;</span>
    server_name mirror.jx.com<span class="token punctuation">;</span>
    root /code<span class="token punctuation">;</span>
...
<br>
<h4 id="_6-3-7-综合案例" tabindex="-1"><a class="header-anchor" href="#_6-3-7-综合案例" aria-hidden="true">#</a> 6.3.7 综合案例</h4>
<ul>
...
<br>
<h3 id="_6-4-nginx-状态监控" tabindex="-1"><a class="header-anchor" href="#_6-4-nginx-状态监控" aria-hidden="true">#</a> 6.4 Nginx 状态监控</h3>
<p><code v-pre>ngx_http_stub_status_module</code>模块提供对基本状态信息的访问。
默认情况下不集成该模块，需要使用--with-http_stub_status_module集成。</p>
<ol>
<li>指令</li>
</ol>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Syntax: stub_status<span class="token punctuation">;</span>
Default: -
...
<h3 id="_6-4-1-提供以下状态信息" tabindex="-1"><a class="header-anchor" href="#_6-4-1-提供以下状态信息" aria-hidden="true">#</a> 6.4.1 提供以下状态信息</h3>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center">Active connections</td>
<td>当前活跃连接数，包括Waiting等待连接数。</td>
</tr>
<tr>
...
<br>
<h3 id="_6-4-2-如何简单理解reading、writing、-waiting。" tabindex="-1"><a class="header-anchor" href="#_6-4-2-如何简单理解reading、writing、-waiting。" aria-hidden="true">#</a> 6.4.2 如何简单理解Reading、Writing、 Waiting。</h3>
<p>假设现在有两条船分别为: C、S。C船需要S船的1个物品，那么此时C船就要给S船发送一个消息。</p>
<ol>
<li>S船收到这个消息时就是reading。</li>
<li>S船将物资发送给C船，这个时候就是writing。</li>
<li>如果C船需要S船很多个物品，那么需要C船和S船建立起一个物资传送管道，不断的传送物资。这个管道建立起来的时候，就是waiting状态了。</li>
</ol>
<br>
<br>
<h3 id="_6-5-nginx-location" tabindex="-1"><a class="header-anchor" href="#_6-5-nginx-location" aria-hidden="true">#</a> 6.5 Nginx Location</h3>
<ol>
<li>什么是Location
Location用来控制访问网站的uri路径</li>
</ol>
<br>
<ol start="2">
<li>Location语法</li>
</ol>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>location<span class="token punctuation">[</span><span class="token operator">=</span><span class="token operator">|</span>~<span class="token operator">|</span>~*<span class="token operator">|</span>^~<span class="token punctuation">]</span>uri<span class="token punctuation">{</span><span class="token punctuation">..</span>.<span class="token punctuation">}</span>
...
<tr>
<td style="text-align:center"><code v-pre>^~</code></td>
<td style="text-align:center">以某个字符串开头</td>
...
<tr>
<td style="text-align:center"><code v-pre>/</code></td>
<td style="text-align:center">通用匹配，任何请求都会匹配到</td>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#测试结果如下(建议是curL测试)</span>
...
<li>Locaiton 规则配置应用场景，可进行验证测试</li>
</ol>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>
server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
