<template><div><h1 id="zookeeper-分布式锁案例" tabindex="-1"><a class="header-anchor" href="#zookeeper-分布式锁案例" aria-hidden="true">#</a> ZooKeeper 分布式锁案例</h1>
...
<figure><img src="https://xin997.oss-cn-beijing.aliyuncs.com/xinblogs/webimg-Linux/elks/image-20211221142619853.png" alt="分布式锁案例" tabindex="0" loading="lazy"><figcaption>分布式锁案例</figcaption></figure>
<br>
<h2 id="curator-框架实现分布式锁案例" tabindex="-1"><a class="header-anchor" href="#curator-框架实现分布式锁案例" aria-hidden="true">#</a> Curator 框架实现分布式锁案例</h2>
<h3 id="原生的-java-api-开发存在的问题" tabindex="-1"><a class="header-anchor" href="#原生的-java-api-开发存在的问题" aria-hidden="true">#</a> <strong>原生的 Java API 开发存在的问题</strong></h3>
<ol>
...
<br>
<p>Curator 是一个专门解决分布式锁的框架，解决了原生 JavaAPI 开发分布式遇到的问题。<br></p>
...
<h3 id="curator-案例实操" tabindex="-1"><a class="header-anchor" href="#curator-案例实操" aria-hidden="true">#</a> Curator 案例实操</h3>
...
<span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">></span></span>
   ...
   <span class="token generics"><span class="token punctuation">&lt;</span>version<span class="token punctuation">></span></span><span class="token number">4.3</span><span class="token number">.0</span><span class="token operator">&lt;</span><span class="token operator">/</span>version<span class="token operator">></span>
<span class="token operator">&lt;</span><span class="token operator">/</span>dependency<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2.代码实现</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>atguigu<span class="token punctuation">.</span>lock</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CuratorLockTest</span> <span class="token punctuation">{</span>
   ...
   <span class="token keyword">private</span> <span class="token class-name">String</span> connectString <span class="token operator">=</span> 
