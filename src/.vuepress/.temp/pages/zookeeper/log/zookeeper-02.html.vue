...
<th>选举端口</th>
<th>软件存放目录</th>
<th style="text-align:right"><code v-pre>myid</code></th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center">zk1</td>
<td>192.168.10.126</td>
<td>2181</td>
<td>2182</td>
<td>2183</td>
<td><code v-pre>/data/server/zk1/{data,logs}</code></td>
<td style="text-align:right">1</td>
</tr>
<tr>
<td style="text-align:center">zk2</td>
<td>192.168.10.127</td>
<td>2181</td>
<td>2182</td>
<td>2183</td>
<td><code v-pre>/data/server/zk2/{data,logs}</code></td>
<td style="text-align:right">2</td>
</tr>
<tr>
<td style="text-align:center">zk3</td>
<td>192.168.10.128</td>
<td>2181</td>
<td>2182</td>
<td>2183</td>
<td><code v-pre>/data/server/zk3/{data,logs}</code></td>
...
<p>因为使用telnet方法来检查集群的节点状态信息比较繁琐，而且经常中断，所以生产中我们一般使用nc软件
来检查Zookeeper集群状态.</p>
<br>
<p>nc全称NetCat，在网络工具中有“瑞士军刀”美誉，支持Windows和Linux。因为它短小精悍(不过25k)、功
能实用，被设计为一个简单、可靠的网络工具，可通过TCP或UDP协议传输读写数据。同时，它还是一个网络应用Debug分析器，因为它可以根据需要创建各种不同类型的网络连接。</p>
